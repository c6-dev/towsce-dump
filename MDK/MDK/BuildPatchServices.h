...
public:
	DMember(char)                                      ManifestFileVersion                                         OFFSET(get<char>, {0x30, 1, 0, 0})
	DMember(bool)                                      bIsFileData                                                 OFFSET(get<bool>, {0x31, 1, 0, 0})
	DMember(uint32_t)                                  AppID                                                       OFFSET(get<uint32_t>, {0x34, 4, 0, 0})
	SMember(FString)                                   AppName                                                     OFFSET(getStruct<T>, {0x38, 16, 0, 0})
	SMember(FString)                                   BuildVersion                                                OFFSET(getStruct<T>, {0x48, 16, 0, 0})
	SMember(FString)                                   LaunchExe                                                   OFFSET(getStruct<T>, {0x58, 16, 0, 0})
	SMember(FString)                                   LaunchCommand                                               OFFSET(getStruct<T>, {0x68, 16, 0, 0})
	CMember(TSet<FString>)                             PrereqIds                                                   OFFSET(get<T>, {0x78, 80, 0, 0})
	SMember(FString)                                   PrereqName                                                  OFFSET(getStruct<T>, {0xC8, 16, 0, 0})
	SMember(FString)                                   PrereqPath                                                  OFFSET(getStruct<T>, {0xD8, 16, 0, 0})
	SMember(FString)                                   PrereqArgs                                                  OFFSET(getStruct<T>, {0xE8, 16, 0, 0})
	CMember(TArray<FFileManifestData>)                 FileManifestList                                            OFFSET(get<T>, {0xF8, 16, 0, 0})
	CMember(TArray<FChunkInfoData>)                    ChunkList                                                   OFFSET(get<T>, {0x108, 16, 0, 0})
	CMember(TArray<FCustomFieldData>)                  CustomFields                                                OFFSET(get<T>, {0x118, 16, 0, 0})
};
