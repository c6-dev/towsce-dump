...
public:
	CMember(class UPhysicsAsset*)                      PhysicsAsset                                                OFFSET(get<T>, {0x50, 8, 0, 0})
	CMember(TMap<FName, class UClothConfigBase*>)      ClothConfigs                                                OFFSET(get<T>, {0x58, 80, 0, 0})
	CMember(TArray<FClothLODDataCommon>)               LODData                                                     OFFSET(get<T>, {0xA8, 16, 0, 0})
	CMember(TArray<int32_t>)                           LodMap                                                      OFFSET(get<T>, {0xB8, 16, 0, 0})
	CMember(TArray<FName>)                             UsedBoneNames                                               OFFSET(get<T>, {0xC8, 16, 0, 0})
	CMember(TArray<int32_t>)                           UsedBoneIndices                                             OFFSET(get<T>, {0xD8, 16, 0, 0})
	DMember(int32_t)                                   ReferenceBoneIndex                                          OFFSET(get<int32_t>, {0xE8, 4, 0, 0})
	CMember(class UClothingAssetCustomData*)           CustomData                                                  OFFSET(get<T>, {0xF0, 8, 0, 0})
};
...
public:
	CMember(class UClothPhysicalMeshDataBase_Legacy*)  PhysicalMeshData                                            OFFSET(get<T>, {0x30, 8, 0, 0})
	SMember(FClothPhysicalMeshData)                    ClothPhysicalMeshData                                       OFFSET(getStruct<T>, {0x38, 248, 0, 0})
	SMember(FClothCollisionData)                       CollisionData                                               OFFSET(getStruct<T>, {0x130, 64, 0, 0})
};
