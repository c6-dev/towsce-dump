...
public:
	...
	SMember(FMulticastInlineDelegate)                  OnBlendOut                                                  OFFSET(getStruct<T>, {0x40, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnInterrupted                                               OFFSET(getStruct<T>, {0x50, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnNotifyBegin                                               OFFSET(getStruct<T>, {0x60, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnNotifyEnd                                                 OFFSET(getStruct<T>, {0x70, 16, 0, 0})
...
public:
	...
	DMember(bool)                                      bForceResetPlayTime                                         OFFSET(get<bool>, {0x58, 1, 0, 0})
	CMember(class UBlendSpaceBase*)                    PreviousBlendSpace                                          OFFSET(get<T>, {0xE8, 8, 0, 0})
};
...
public:
	DMember(float)                                     NormalizedTime                                              OFFSET(get<float>, {0xF0, 4, 0, 0})
};
...
public:
	...
	DMember(float)                                     PlayRate                                                    OFFSET(get<float>, {0x20, 4, 0, 0})
	DMember(bool)                                      bShuffleMode                                                OFFSET(get<bool>, {0x78, 1, 0, 0})
};
...
public:
	SMember(FPoseLink)                                 BasePose                                                    OFFSET(getStruct<T>, {0xF0, 16, 0, 0})
	DMember(int32_t)                                   LODThreshold                                                OFFSET(get<int32_t>, {0x100, 4, 0, 0})
	DMember(float)                                     Alpha                                                       OFFSET(get<float>, {0x104, 4, 0, 0})
	SMember(FInputScaleBias)                           AlphaScaleBias                                              OFFSET(getStruct<T>, {0x108, 8, 0, 0})
	SMember(FInputAlphaBoolBlend)                      AlphaBoolBlend                                              OFFSET(getStruct<T>, {0x110, 72, 0, 0})
	SMember(FName)                                     AlphaCurveName                                              OFFSET(getStruct<T>, {0x158, 8, 0, 0})
	SMember(FInputScaleBiasClamp)                      AlphaScaleBiasClamp                                         OFFSET(getStruct<T>, {0x160, 48, 0, 0})
	CMember(EAnimAlphaInputType)                       AlphaInputType                                              OFFSET(get<T>, {0x194, 1, 0, 0})
	DMember(bool)                                      bAlphaBoolEnabled                                           OFFSET(get<bool>, {0x195, 1, 0, 0})
};
