...
public:
	CMember(TSet<FName>)                               Layers                                                      OFFSET(get<T>, {0x38, 80, 0, 0})
	CMember(TSet<FName>)                               Tags                                                        OFFSET(get<T>, {0x88, 80, 0, 0})
};
...
public:
	CMember(TEnumAsByte<EComponentMobility>)           Mobility                                                    OFFSET(get<T>, {0x2B8, 1, 0, 0})
	CMember(EDatasmithAreaLightActorType)              LightType                                                   OFFSET(get<T>, {0x2B9, 1, 0, 0})
	CMember(EDatasmithAreaLightActorShape)             LightShape                                                  OFFSET(get<T>, {0x2BA, 1, 0, 0})
	SMember(FVector2D)                                 Dimensions                                                  OFFSET(getStruct<T>, {0x2BC, 8, 0, 0})
	DMember(float)                                     Intensity                                                   OFFSET(get<float>, {0x2C4, 4, 0, 0})
	CMember(ELightUnits)                               IntensityUnits                                              OFFSET(get<T>, {0x2C8, 1, 0, 0})
	SMember(FLinearColor)                              Color                                                       OFFSET(getStruct<T>, {0x2CC, 16, 0, 0})
	DMember(float)                                     Temperature                                                 OFFSET(get<float>, {0x2DC, 4, 0, 0})
	CMember(class UTextureLightProfile*)               IESTexture                                                  OFFSET(get<T>, {0x2E0, 8, 0, 0})
	DMember(bool)                                      bUseIESBrightness                                           OFFSET(get<bool>, {0x2E8, 1, 0, 0})
	DMember(float)                                     IESBrightnessScale                                          OFFSET(get<float>, {0x2EC, 4, 0, 0})
	SMember(FRotator)                                  Rotation                                                    OFFSET(getStruct<T>, {0x2F0, 12, 0, 0})
	DMember(float)                                     SourceRadius                                                OFFSET(get<float>, {0x2FC, 4, 0, 0})
	DMember(float)                                     SourceLength                                                OFFSET(get<float>, {0x300, 4, 0, 0})
	DMember(float)                                     AttenuationRadius                                           OFFSET(get<float>, {0x304, 4, 0, 0})
	DMember(float)                                     SpotlightInnerAngle                                         OFFSET(get<float>, {0x308, 4, 0, 0})
	DMember(float)                                     SpotlightOuterAngle                                         OFFSET(get<float>, {0x30C, 4, 0, 0})
};
...
public:
	CMember(EDatasmithAreaLightActorType)              LightType                                                   OFFSET(get<T>, {0x38, 1, 0, 0})
	CMember(EDatasmithAreaLightActorShape)             LightShape                                                  OFFSET(get<T>, {0x39, 1, 0, 0})
	SMember(FVector2D)                                 Dimensions                                                  OFFSET(getStruct<T>, {0x3C, 8, 0, 0})
	SMember(FLinearColor)                              Color                                                       OFFSET(getStruct<T>, {0x44, 16, 0, 0})
	DMember(float)                                     Intensity                                                   OFFSET(get<float>, {0x54, 4, 0, 0})
	CMember(ELightUnits)                               IntensityUnits                                              OFFSET(get<T>, {0x58, 1, 0, 0})
	DMember(float)                                     Temperature                                                 OFFSET(get<float>, {0x5C, 4, 0, 0})
	CMember(TWeakObjectPtr<class UTextureLightProfile*>) IESTexture                                                OFFSET(get<T>, {0x60, 8, 0, 0})
	DMember(bool)                                      bUseIESBrightness                                           OFFSET(get<bool>, {0x88, 1, 0, 0})
	DMember(float)                                     IESBrightnessScale                                          OFFSET(get<float>, {0x8C, 4, 0, 0})
	SMember(FRotator)                                  Rotation                                                    OFFSET(getStruct<T>, {0x90, 12, 0, 0})
	DMember(float)                                     SourceRadius                                                OFFSET(get<float>, {0x9C, 4, 0, 0})
	DMember(float)                                     SourceLength                                                OFFSET(get<float>, {0xA0, 4, 0, 0})
	DMember(float)                                     AttenuationRadius                                           OFFSET(get<float>, {0xA4, 4, 0, 0})
};
...
public:
	SMember(FString)                                   Generator                                                   OFFSET(getStruct<T>, {0x30, 16, 0, 0})
	DMember(float)                                     Version                                                     OFFSET(get<float>, {0x40, 4, 0, 0})
	SMember(FString)                                   Author                                                      OFFSET(getStruct<T>, {0x48, 16, 0, 0})
	SMember(FString)                                   License                                                     OFFSET(getStruct<T>, {0x58, 16, 0, 0})
	SMember(FString)                                   Source                                                      OFFSET(getStruct<T>, {0x68, 16, 0, 0})
};
...
public:
	SMember(FString)                                   SourceMeshName                                              OFFSET(getStruct<T>, {0x30, 16, 0, 0})
};
...
public:
	DMember(bool)                                      bGenerateLightmapUVs                                        OFFSET(get<bool>, {0x30, 1, 0, 0})
	SMember(FString)                                   TexturesDir                                                 OFFSET(getStruct<T>, {0x38, 16, 0, 0})
	DMember(char)                                      IntermediateSerialization                                   OFFSET(get<char>, {0x48, 1, 0, 0})
	DMember(bool)                                      bColorizeMaterials                                          OFFSET(get<bool>, {0x49, 1, 0, 0})
};
...
public:
	DMember(bool)                                      bMergeNodes                                                 OFFSET(get<bool>, {0x50, 1, 0, 0})
	DMember(bool)                                      bOptimizeDuplicatedNodes                                    OFFSET(get<bool>, {0x51, 1, 0, 0})
	DMember(bool)                                      bRemoveInvisibleNodes                                       OFFSET(get<bool>, {0x52, 1, 0, 0})
	DMember(bool)                                      bSimplifyNodeHierarchy                                      OFFSET(get<bool>, {0x53, 1, 0, 0})
	DMember(bool)                                      bImportVar                                                  OFFSET(get<bool>, {0x54, 1, 0, 0})
	SMember(FString)                                   VarPath                                                     OFFSET(getStruct<T>, {0x58, 16, 0, 0})
	DMember(bool)                                      bImportPos                                                  OFFSET(get<bool>, {0x68, 1, 0, 0})
	SMember(FString)                                   PosPath                                                     OFFSET(getStruct<T>, {0x70, 16, 0, 0})
	DMember(bool)                                      bImportTml                                                  OFFSET(get<bool>, {0x80, 1, 0, 0})
	SMember(FString)                                   TmlPath                                                     OFFSET(getStruct<T>, {0x88, 16, 0, 0})
};
...
public:
	DMember(bool)                                      bMergeNodes                                                 OFFSET(get<bool>, {0x50, 1, 0, 0})
	DMember(bool)                                      bOptimizeDuplicatedNodes                                    OFFSET(get<bool>, {0x51, 1, 0, 0})
	DMember(bool)                                      bImportMats                                                 OFFSET(get<bool>, {0x52, 1, 0, 0})
	SMember(FString)                                   MatsPath                                                    OFFSET(getStruct<T>, {0x58, 16, 0, 0})
	DMember(bool)                                      bImportVar                                                  OFFSET(get<bool>, {0x68, 1, 0, 0})
	DMember(bool)                                      bCleanVar                                                   OFFSET(get<bool>, {0x69, 1, 0, 0})
	SMember(FString)                                   VarPath                                                     OFFSET(getStruct<T>, {0x70, 16, 0, 0})
	DMember(bool)                                      bImportLightInfo                                            OFFSET(get<bool>, {0x80, 1, 0, 0})
	SMember(FString)                                   LightInfoPath                                               OFFSET(getStruct<T>, {0x88, 16, 0, 0})
	DMember(bool)                                      bImportClipInfo                                             OFFSET(get<bool>, {0x98, 1, 0, 0})
	SMember(FString)                                   ClipInfoPath                                                OFFSET(getStruct<T>, {0xA0, 16, 0, 0})
};
...
public:
	SMember(FString)                                   SourceGlobalId                                              OFFSET(getStruct<T>, {0x30, 16, 0, 0})
};
...
public:
	CMember(TMap<FName, FString>)                      MetaData                                                    OFFSET(get<T>, {0x30, 80, 0, 0})
};
...
public:
	SMember(FDatasmithCameraLookatTrackingSettingsTemplate) LookatTrackingSettings                                 OFFSET(getStruct<T>, {0x38, 48, 0, 0})
};
...
public:
	SMember(FDatasmithCameraFilmbackSettingsTemplate)  FilmbackSettings                                            OFFSET(getStruct<T>, {0x38, 8, 0, 0})
	SMember(FDatasmithCameraLensSettingsTemplate)      LensSettings                                                OFFSET(getStruct<T>, {0x40, 4, 0, 0})
	SMember(FDatasmithCameraFocusSettingsTemplate)     FocusSettings                                               OFFSET(getStruct<T>, {0x44, 8, 0, 0})
	DMember(float)                                     CurrentFocalLength                                          OFFSET(get<float>, {0x4C, 4, 0, 0})
	DMember(float)                                     CurrentAperture                                             OFFSET(get<float>, {0x50, 4, 0, 0})
	SMember(FDatasmithPostProcessSettingsTemplate)     PostProcessSettings                                         OFFSET(getStruct<T>, {0x60, 64, 0, 0})
};
...
public:
	DMember(int32_t)                                   SortOrder                                                   OFFSET(get<int32_t>, {0x38, 4, 0, 0})
	SMember(FVector)                                   DecalSize                                                   OFFSET(getStruct<T>, {0x3C, 12, 0, 0})
...
public:
	CMember(TArray<class ULevelSequence*>)             ImportedSequences                                           OFFSET(get<T>, {0x2B8, 16, 0, 0})
...
public:
	SMember(FDatasmithTessellationOptions)             Options                                                     OFFSET(getStruct<T>, {0x30, 16, 0, 0})
};
...
public:
	CMember(EDatasmithImportSearchPackagePolicy)       SearchPackagePolicy                                         OFFSET(get<T>, {0x30, 1, 0, 0})
	CMember(EDatasmithImportAssetConflictPolicy)       MaterialConflictPolicy                                      OFFSET(get<T>, {0x31, 1, 0, 0})
	CMember(EDatasmithImportAssetConflictPolicy)       TextureConflictPolicy                                       OFFSET(get<T>, {0x32, 1, 0, 0})
	CMember(EDatasmithImportActorPolicy)               StaticMeshActorImportPolicy                                 OFFSET(get<T>, {0x33, 1, 0, 0})
	CMember(EDatasmithImportActorPolicy)               LightImportPolicy                                           OFFSET(get<T>, {0x34, 1, 0, 0})
	CMember(EDatasmithImportActorPolicy)               CameraImportPolicy                                          OFFSET(get<T>, {0x35, 1, 0, 0})
	CMember(EDatasmithImportActorPolicy)               OtherActorImportPolicy                                      OFFSET(get<T>, {0x36, 1, 0, 0})
	CMember(EDatasmithImportMaterialQuality)           MaterialQuality                                             OFFSET(get<T>, {0x37, 1, 0, 0})
	SMember(FDatasmithImportBaseOptions)               BaseOptions                                                 OFFSET(getStruct<T>, {0x38, 20, 0, 0})
	SMember(FDatasmithReimportOptions)                 ReimportOptions                                             OFFSET(getStruct<T>, {0x4C, 2, 0, 0})
...
public:
	CMember(class UMaterialInterface*)                 LandscapeMaterial                                           OFFSET(get<T>, {0x38, 8, 0, 0})
	DMember(int32_t)                                   StaticLightingLOD                                           OFFSET(get<int32_t>, {0x40, 4, 0, 0})
};
...
public:
	DMember(bool)                                      bVisible                                                    OFFSET(get<bool>, {0x38, 1, 1, 0})
	DMember(bool)                                      CastShadows                                                 OFFSET(get<bool>, {0x3C, 1, 1, 0})
	DMember(bool)                                      bUseTemperature                                             OFFSET(get<bool>, {0x3C, 1, 1, 1})
	DMember(bool)                                      bUseIESBrightness                                           OFFSET(get<bool>, {0x3C, 1, 1, 2})
	DMember(float)                                     Intensity                                                   OFFSET(get<float>, {0x40, 4, 0, 0})
	DMember(float)                                     Temperature                                                 OFFSET(get<float>, {0x44, 4, 0, 0})
	DMember(float)                                     IESBrightnessScale                                          OFFSET(get<float>, {0x48, 4, 0, 0})
	SMember(FLinearColor)                              LightColor                                                  OFFSET(getStruct<T>, {0x4C, 16, 0, 0})
	CMember(class UMaterialInterface*)                 LightFunctionMaterial                                       OFFSET(get<T>, {0x60, 8, 0, 0})
	CMember(class UTextureLightProfile*)               IESTexture                                                  OFFSET(get<T>, {0x68, 8, 0, 0})
};
...
public:
	CMember(TWeakObjectPtr<class UMaterialInterface*>) ParentMaterial                                              OFFSET(get<T>, {0x38, 8, 0, 0})
	CMember(TMap<FName, float>)                        ScalarParameterValues                                       OFFSET(get<T>, {0x60, 80, 0, 0})
	CMember(TMap<FName, FLinearColor>)                 VectorParameterValues                                       OFFSET(get<T>, {0xB0, 80, 0, 0})
	CMember(TMap<FName, TWeakObjectPtr<UTexture*>>)    TextureParameterValues                                      OFFSET(get<T>, {0x100, 80, 0, 0})
	SMember(FDatasmithStaticParameterSetTemplate)      StaticParameters                                            OFFSET(getStruct<T>, {0x150, 80, 0, 0})
};
...
public:
	CMember(ELightUnits)                               IntensityUnits                                              OFFSET(get<T>, {0x38, 1, 0, 0})
	DMember(float)                                     SourceRadius                                                OFFSET(get<float>, {0x3C, 4, 0, 0})
	DMember(float)                                     SourceLength                                                OFFSET(get<float>, {0x40, 4, 0, 0})
	DMember(float)                                     AttenuationRadius                                           OFFSET(get<float>, {0x44, 4, 0, 0})
};
...
public:
	SMember(FDatasmithPostProcessSettingsTemplate)     Settings                                                    OFFSET(getStruct<T>, {0x40, 64, 0, 0})
	DMember(bool)                                      bEnabled                                                    OFFSET(get<bool>, {0x80, 1, 1, 0})
	DMember(bool)                                      bUnbound                                                    OFFSET(get<bool>, {0x80, 1, 1, 1})
};
...
public:
	CMember(class UDatasmithScene*)                    Scene                                                       OFFSET(get<T>, {0x2B8, 8, 0, 0})
	CMember(TMap<FName, TWeakObjectPtr<AActor*>>)      RelatedActors                                               OFFSET(get<T>, {0x2C0, 80, 0, 0})
};
...
public:
	SMember(FTransform)                                RelativeTransform                                           OFFSET(getStruct<T>, {0x40, 48, 0, 0})
	CMember(TEnumAsByte<EComponentMobility>)           Mobility                                                    OFFSET(get<T>, {0x70, 1, 0, 0})
	CMember(TWeakObjectPtr<class USceneComponent*>)    AttachParent                                                OFFSET(get<T>, {0x78, 8, 0, 0})
	DMember(bool)                                      bVisible                                                    OFFSET(get<bool>, {0xA0, 1, 0, 0})
	CMember(TSet<FName>)                               Tags                                                        OFFSET(get<T>, {0xA8, 80, 0, 0})
};
...
public:
	CMember(TEnumAsByte<ESkyLightSourceType>)          SourceType                                                  OFFSET(get<T>, {0x38, 1, 0, 0})
	DMember(int32_t)                                   CubemapResolution                                           OFFSET(get<int32_t>, {0x3C, 4, 0, 0})
	CMember(class UTextureCube*)                       Cubemap                                                     OFFSET(get<T>, {0x40, 8, 0, 0})
};
...
public:
	DMember(float)                                     InnerConeAngle                                              OFFSET(get<float>, {0x38, 4, 0, 0})
	DMember(float)                                     OuterConeAngle                                              OFFSET(get<float>, {0x3C, 4, 0, 0})
};
...
public:
	...
	CMember(TArray<class UMaterialInterface*>)         OverrideMaterials                                           OFFSET(get<T>, {0x40, 16, 0, 0})
};
...
public:
	SMember(FDatasmithMeshSectionInfoMapTemplate)      SectionInfoMap                                              OFFSET(getStruct<T>, {0x38, 80, 0, 0})
	DMember(int32_t)                                   LightMapCoordinateIndex                                     OFFSET(get<int32_t>, {0x88, 4, 0, 0})
	DMember(int32_t)                                   LightMapResolution                                          OFFSET(get<int32_t>, {0x8C, 4, 0, 0})
	CMember(TArray<FDatasmithMeshBuildSettingsTemplate>) BuildSettings                                             OFFSET(get<T>, {0x90, 16, 0, 0})
	CMember(TArray<FDatasmithStaticMaterialTemplate>)  StaticMaterials                                             OFFSET(get<T>, {0xA0, 16, 0, 0})
};
