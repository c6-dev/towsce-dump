...
public:
	CMember(class UClass*)                             Role                                                        OFFSET(get<T>, {0x38, 8, 0, 0})
	CMember(TArray<FLiveLinkSubjectName>)              Subjects                                                    OFFSET(get<T>, {0x40, 16, 0, 0})
	CMember(TArray<class ULiveLinkFrameTranslator*>)   FrameTranslators                                            OFFSET(get<T>, {0x50, 16, 0, 0})
...
public:
	CMember(ELiveLinkSourceMode)                       Mode                                                        OFFSET(get<T>, {0x30, 1, 0, 0})
	SMember(FLiveLinkSourceBufferManagementSettings)   BufferSettings                                              OFFSET(getStruct<T>, {0x38, 88, 0, 0})
...
public:
	CMember(TArray<class ULiveLinkFramePreProcessor*>) PreProcessors                                               OFFSET(get<T>, {0x30, 16, 0, 0})
	CMember(class ULiveLinkFrameInterpolationProcessor*) InterpolationProcessor                                    OFFSET(get<T>, {0x40, 8, 0, 0})
	CMember(TArray<class ULiveLinkFrameTranslator*>)   Translators                                                 OFFSET(get<T>, {0x48, 16, 0, 0})
	CMember(class UClass*)                             Role                                                        OFFSET(get<T>, {0x58, 8, 0, 0})
	SMember(FFrameRate)                                FrameRate                                                   OFFSET(getStruct<T>, {0x60, 8, 0, 0})
	DMember(bool)                                      bRebroadcastSubject                                         OFFSET(get<bool>, {0x68, 1, 0, 0})
};
