...
public:
	DMember(int32_t)                                   PlayerIndex                                                 OFFSET(get<int32_t>, {0x4F8, 4, 0, 0})
	CMember(EControllerHand)                           Hand                                                        OFFSET(get<T>, {0x4FC, 1, 0, 0})
	SMember(FName)                                     MotionSource                                                OFFSET(getStruct<T>, {0x500, 8, 0, 0})
	...
	DMember(bool)                                      bDisplayDeviceModel                                         OFFSET(get<bool>, {0x50D, 1, 0, 0})
	SMember(FName)                                     DisplayModelSource                                          OFFSET(getStruct<T>, {0x510, 8, 0, 0})
	CMember(class UStaticMesh*)                        CustomDisplayMesh                                           OFFSET(get<T>, {0x518, 8, 0, 0})
	CMember(TArray<class UMaterialInterface*>)         DisplayMeshMaterialOverrides                                OFFSET(get<T>, {0x520, 16, 0, 0})
	CMember(class UPrimitiveComponent*)                DisplayComponent                                            OFFSET(get<T>, {0x590, 8, 0, 0})
...
public:
	SMember(FMulticastInlineDelegate)                  HMDTrackingInitializingAndNeedsHMDToBeTrackedDelegate       OFFSET(getStruct<T>, {0xE0, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  HMDTrackingInitializedDelegate                              OFFSET(getStruct<T>, {0xF0, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  HMDRecenteredDelegate                                       OFFSET(getStruct<T>, {0x100, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  HMDLostDelegate                                             OFFSET(getStruct<T>, {0x110, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  HMDReconnectedDelegate                                      OFFSET(getStruct<T>, {0x120, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  HMDConnectCanceledDelegate                                  OFFSET(getStruct<T>, {0x130, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  HMDPutOnHeadDelegate                                        OFFSET(getStruct<T>, {0x140, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  HMDRemovedFromHeadDelegate                                  OFFSET(getStruct<T>, {0x150, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  VRControllerRecenteredDelegate                              OFFSET(getStruct<T>, {0x160, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  XRTrackingOriginChangedDelegate                             OFFSET(getStruct<T>, {0x170, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  XRPlayAreaChangedDelegate                                   OFFSET(getStruct<T>, {0x180, 16, 0, 0})
};
...
public:
	SMember(FMulticastInlineDelegate)                  OnModelLoaded                                               OFFSET(getStruct<T>, {0x38, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnLoadFailure                                               OFFSET(getStruct<T>, {0x48, 16, 0, 0})
	CMember(class UPrimitiveComponent*)                SpawnedComponent                                            OFFSET(get<T>, {0x60, 8, 0, 0})
