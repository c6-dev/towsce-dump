...
public:
	CMember(TArray<FNamedInterface>)                   NamedInterfaces                                             OFFSET(get<T>, {0x30, 16, 0, 0})
	CMember(TArray<FNamedInterfaceDef>)                NamedInterfaceDefs                                          OFFSET(get<T>, {0x40, 16, 0, 0})
};
...
public:
	...
	// void OnMatchReceivedTurn(FString Match, bool bDidBecomeActive);                                                          // [0x1c5deb0] Event|Public|BlueprintEvent 
	// Function /Script/OnlineSubsystem.TurnBasedMatchInterface.OnMatchEnded
	// void OnMatchEnded(FString Match);                                                                                        // [0x1c5deb0] Event|Public|BlueprintEvent 
};
