...
public:
	SMember(FButtonStyle)                              ButtonStyle                                                 OFFSET(getStruct<T>, {0x38, 632, 0, 0})
};

/// Class /Script/Slate.CheckBoxWidgetStyle
/// Size: 0x0580 (0x000038 - 0x0005B8)
...
public:
	SMember(FCheckBoxStyle)                            CheckBoxStyle                                               OFFSET(getStruct<T>, {0x38, 1408, 0, 0})
};

/// Class /Script/Slate.ComboBoxWidgetStyle
/// Size: 0x03F0 (0x000038 - 0x000428)
...
public:
	SMember(FComboBoxStyle)                            ComboBoxStyle                                               OFFSET(getStruct<T>, {0x38, 1008, 0, 0})
};

/// Class /Script/Slate.ComboButtonWidgetStyle
/// Size: 0x03B8 (0x000038 - 0x0003F0)
...
public:
	SMember(FComboButtonStyle)                         ComboButtonStyle                                            OFFSET(getStruct<T>, {0x38, 952, 0, 0})
};

/// Class /Script/Slate.EditableTextBoxWidgetStyle
/// Size: 0x07F8 (0x000038 - 0x000830)
...
public:
	SMember(FEditableTextBoxStyle)                     EditableTextBoxStyle                                        OFFSET(getStruct<T>, {0x38, 2040, 0, 0})
};
...
public:
	SMember(FEditableTextStyle)                        EditableTextStyle                                           OFFSET(getStruct<T>, {0x38, 544, 0, 0})
};
...
public:
	SMember(FProgressBarStyle)                         ProgressBarStyle                                            OFFSET(getStruct<T>, {0x38, 416, 0, 0})
};

/// Class /Script/Slate.ScrollBarWidgetStyle
/// Size: 0x04D0 (0x000038 - 0x000508)
...
public:
	SMember(FScrollBarStyle)                           ScrollBarStyle                                              OFFSET(getStruct<T>, {0x38, 1232, 0, 0})
};
...
public:
	SMember(FScrollBoxStyle)                           ScrollBoxStyle                                              OFFSET(getStruct<T>, {0x38, 552, 0, 0})
};
...
public:
	DMember(bool)                                      bExplicitCanvasChildZOrder                                  OFFSET(get<bool>, {0x30, 1, 0, 0})
};

/// Class /Script/Slate.SpinBoxWidgetStyle
/// Size: 0x02E8 (0x000038 - 0x000320)
...
public:
	SMember(FSpinBoxStyle)                             SpinBoxStyle                                                OFFSET(getStruct<T>, {0x38, 744, 0, 0})
};
