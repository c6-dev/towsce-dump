...
public:
	SMember(FRigVMMemoryContainer)                     WorkMemoryStorage                                           OFFSET(getStruct<T>, {0x30, 160, 0, 0})
	SMember(FRigVMMemoryContainer)                     LiteralMemoryStorage                                        OFFSET(getStruct<T>, {0xD8, 160, 0, 0})
	SMember(FRigVMByteCode)                            ByteCodeStorage                                             OFFSET(getStruct<T>, {0x180, 48, 0, 0})
	SMember(FRigVMInstructionArray)                    Instructions                                                OFFSET(getStruct<T>, {0x1B8, 16, 0, 0})
	SMember(FRigVMExecuteContext)                      Context                                                     OFFSET(getStruct<T>, {0x1C8, 88, 0, 0})
	CMember(TArray<FName>)                             FunctionNamesStorage                                        OFFSET(get<T>, {0x220, 16, 0, 0})
	CMember(TArray<FRigVMParameter>)                   Parameters                                                  OFFSET(get<T>, {0x250, 16, 0, 0})
	CMember(TMap<FName, int32_t>)                      ParametersNameMap                                           OFFSET(get<T>, {0x260, 80, 0, 0})
	CMember(class URigVM*)                             DeferredVMToCopy                                            OFFSET(get<T>, {0x2F8, 8, 0, 0})
