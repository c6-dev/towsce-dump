...
public:
	CMember(class UField*)                             Next                                                        OFFSET(get<T>, {0x30, 8, 0, 0})
};
...
public:
	CMember(class UStruct*)                            SuperStruct                                                 OFFSET(get<T>, {0x38, 8, 0, 0})
	CMember(class UField*)                             Children                                                    OFFSET(get<T>, {0x40, 8, 0, 0})
};
...
public:
	SMember(FName)                                     BundleName                                                  OFFSET(getStruct<T>, {0x0, 8, 0, 0})
	CMember(TArray<FSoftObjectPath>)                   BundleAssets                                                OFFSET(get<T>, {0x8, 16, 0, 0})
};
