...
public:
	CMember(class ANavigationData*)                    MainNavData                                                 OFFSET(get<T>, {0x30, 8, 0, 0})
	CMember(class ANavigationData*)                    AbstractNavData                                             OFFSET(get<T>, {0x38, 8, 0, 0})
	SMember(FName)                                     DefaultAgentName                                            OFFSET(getStruct<T>, {0x40, 8, 0, 0})
	CMember(TSoftObjectPtr<class UClass*>)             CrowdManagerClass                                           OFFSET(get<T>, {0x48, 40, 0, 0})
	...
	DMember(bool)                                      bGenerateNavigationOnlyAroundNavigationInvokers             OFFSET(get<bool>, {0x71, 1, 1, 1})
	DMember(float)                                     ActiveTilesUpdateInterval                                   OFFSET(get<float>, {0x74, 4, 0, 0})
	...
	CMember(TArray<class ANavigationData*>)            NavDataSet                                                  OFFSET(get<T>, {0x98, 16, 0, 0})
	CMember(TArray<class ANavigationData*>)            NavDataRegistrationQueue                                    OFFSET(get<T>, {0xA8, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnNavDataRegisteredEvent                                    OFFSET(getStruct<T>, {0xC8, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnNavigationGenerationFinishedDelegate                      OFFSET(getStruct<T>, {0xD8, 16, 0, 0})
	SMember(FNavigationSystemRunMode)                  OperationMode                                               OFFSET(getStruct<T>, {0x1C4, 1, 0, 0})
	DMember(float)                                     DirtyAreasUpdateFreq                                        OFFSET(get<float>, {0x1614, 4, 0, 0})
...
public:
	DMember(bool)                                      bAttachToOwnersRoot                                         OFFSET(get<bool>, {0x104, 1, 1, 0})
	CMember(class UObject*)                            CachedNavParent                                             OFFSET(get<T>, {0x108, 8, 0, 0})
...
public:
	DMember(float)                                     DefaultCost                                                 OFFSET(get<float>, {0x38, 4, 0, 0})
	DMember(float)                                     FixedAreaEnteringCost                                       OFFSET(get<float>, {0x3C, 4, 0, 0})
	SMember(FColor)                                    DrawColor                                                   OFFSET(getStruct<T>, {0x40, 4, 0, 0})
	SMember(FNavAgentSelector)                         SupportedAgents                                             OFFSET(getStruct<T>, {0x44, 4, 0, 0})
	DMember(bool)                                      bSupportsAgent0                                             OFFSET(get<bool>, {0x48, 1, 1, 0})
	DMember(bool)                                      bSupportsAgent1                                             OFFSET(get<bool>, {0x48, 1, 1, 1})
	DMember(bool)                                      bSupportsAgent2                                             OFFSET(get<bool>, {0x48, 1, 1, 2})
	DMember(bool)                                      bSupportsAgent3                                             OFFSET(get<bool>, {0x48, 1, 1, 3})
	DMember(bool)                                      bSupportsAgent4                                             OFFSET(get<bool>, {0x48, 1, 1, 4})
	DMember(bool)                                      bSupportsAgent5                                             OFFSET(get<bool>, {0x48, 1, 1, 5})
	DMember(bool)                                      bSupportsAgent6                                             OFFSET(get<bool>, {0x48, 1, 1, 6})
	DMember(bool)                                      bSupportsAgent7                                             OFFSET(get<bool>, {0x48, 1, 1, 7})
	DMember(bool)                                      bSupportsAgent8                                             OFFSET(get<bool>, {0x49, 1, 1, 0})
	DMember(bool)                                      bSupportsAgent9                                             OFFSET(get<bool>, {0x49, 1, 1, 1})
	DMember(bool)                                      bSupportsAgent10                                            OFFSET(get<bool>, {0x49, 1, 1, 2})
	DMember(bool)                                      bSupportsAgent11                                            OFFSET(get<bool>, {0x49, 1, 1, 3})
	DMember(bool)                                      bSupportsAgent12                                            OFFSET(get<bool>, {0x49, 1, 1, 4})
	DMember(bool)                                      bSupportsAgent13                                            OFFSET(get<bool>, {0x49, 1, 1, 5})
	DMember(bool)                                      bSupportsAgent14                                            OFFSET(get<bool>, {0x49, 1, 1, 6})
	DMember(bool)                                      bSupportsAgent15                                            OFFSET(get<bool>, {0x49, 1, 1, 7})
};
...
public:
	CMember(TArray<FNavigationFilterArea>)             Areas                                                       OFFSET(get<T>, {0x30, 16, 0, 0})
	SMember(FNavigationFilterFlags)                    IncludeFlags                                                OFFSET(getStruct<T>, {0x40, 4, 0, 0})
	SMember(FNavigationFilterFlags)                    ExcludeFlags                                                OFFSET(getStruct<T>, {0x44, 4, 0, 0})
};
...
public:
	CMember(class UPrimitiveComponent*)                RenderingComp                                               OFFSET(get<T>, {0x2C0, 8, 0, 0})
	SMember(FNavDataConfig)                            NavDataConfig                                               OFFSET(getStruct<T>, {0x2C8, 152, 0, 0})
	DMember(bool)                                      bEnableDrawing                                              OFFSET(get<bool>, {0x360, 1, 1, 0})
	DMember(bool)                                      bForceRebuildOnLoad                                         OFFSET(get<bool>, {0x360, 1, 1, 1})
	DMember(bool)                                      bAutoDestroyWhenNoNavigation                                OFFSET(get<bool>, {0x360, 1, 1, 2})
	DMember(bool)                                      bCanBeMainNavData                                           OFFSET(get<bool>, {0x360, 1, 1, 3})
	DMember(bool)                                      bCanSpawnOnRebuild                                          OFFSET(get<bool>, {0x360, 1, 1, 4})
	DMember(bool)                                      bRebuildAtRuntime                                           OFFSET(get<bool>, {0x360, 1, 1, 5})
	CMember(ERuntimeGenerationType)                    RuntimeGeneration                                           OFFSET(get<T>, {0x364, 1, 0, 0})
	DMember(float)                                     ObservedPathsTickInterval                                   OFFSET(get<float>, {0x368, 4, 0, 0})
	DMember(uint32_t)                                  DataVersion                                                 OFFSET(get<uint32_t>, {0x36C, 4, 0, 0})
	CMember(TArray<FSupportedAreaData>)                SupportedAreas                                              OFFSET(get<T>, {0x478, 16, 0, 0})
};
...
public:
	CMember(class UClass*)                             Agent0Area                                                  OFFSET(get<T>, {0x50, 8, 0, 0})
	CMember(class UClass*)                             Agent1Area                                                  OFFSET(get<T>, {0x58, 8, 0, 0})
	CMember(class UClass*)                             Agent2Area                                                  OFFSET(get<T>, {0x60, 8, 0, 0})
	CMember(class UClass*)                             Agent3Area                                                  OFFSET(get<T>, {0x68, 8, 0, 0})
	CMember(class UClass*)                             Agent4Area                                                  OFFSET(get<T>, {0x70, 8, 0, 0})
	CMember(class UClass*)                             Agent5Area                                                  OFFSET(get<T>, {0x78, 8, 0, 0})
	CMember(class UClass*)                             Agent6Area                                                  OFFSET(get<T>, {0x80, 8, 0, 0})
	CMember(class UClass*)                             Agent7Area                                                  OFFSET(get<T>, {0x88, 8, 0, 0})
	CMember(class UClass*)                             Agent8Area                                                  OFFSET(get<T>, {0x90, 8, 0, 0})
	CMember(class UClass*)                             Agent9Area                                                  OFFSET(get<T>, {0x98, 8, 0, 0})
	CMember(class UClass*)                             Agent10Area                                                 OFFSET(get<T>, {0xA0, 8, 0, 0})
	CMember(class UClass*)                             Agent11Area                                                 OFFSET(get<T>, {0xA8, 8, 0, 0})
	CMember(class UClass*)                             Agent12Area                                                 OFFSET(get<T>, {0xB0, 8, 0, 0})
	CMember(class UClass*)                             Agent13Area                                                 OFFSET(get<T>, {0xB8, 8, 0, 0})
	CMember(class UClass*)                             Agent14Area                                                 OFFSET(get<T>, {0xC0, 8, 0, 0})
	CMember(class UClass*)                             Agent15Area                                                 OFFSET(get<T>, {0xC8, 8, 0, 0})
};
...
public:
	CMember(TArray<FNavCollisionCylinder>)             CylinderCollision                                           OFFSET(get<T>, {0x88, 16, 0, 0})
	CMember(TArray<FNavCollisionBox>)                  BoxCollision                                                OFFSET(get<T>, {0x98, 16, 0, 0})
	CMember(class UClass*)                             AreaClass                                                   OFFSET(get<T>, {0xA8, 8, 0, 0})
	DMember(bool)                                      bGatherConvexGeometry                                       OFFSET(get<bool>, {0xB0, 1, 1, 0})
	DMember(bool)                                      bCreateOnClient                                             OFFSET(get<bool>, {0xB0, 1, 1, 1})
};
...
public:
	SMember(FNavGraphNode)                             Node                                                        OFFSET(getStruct<T>, {0x268, 24, 0, 0})
	CMember(class UNavigationGraphNodeComponent*)      NextNodeComponent                                           OFFSET(get<T>, {0x280, 8, 0, 0})
	CMember(class UNavigationGraphNodeComponent*)      PrevNodeComponent                                           OFFSET(get<T>, {0x288, 8, 0, 0})
};
...
public:
	DMember(float)                                     TileGenerationRadius                                        OFFSET(get<float>, {0xE0, 4, 0, 0})
	DMember(float)                                     TileRemovalRadius                                           OFFSET(get<float>, {0xE4, 4, 0, 0})
};
...
public:
	SMember(FMulticastInlineDelegate)                  PathUpdatedNotifier                                         OFFSET(getStruct<T>, {0x30, 16, 0, 0})
	CMember(TArray<FVector>)                           PathPoints                                                  OFFSET(get<T>, {0x40, 16, 0, 0})
	CMember(TEnumAsByte<ENavigationOptionFlag>)        RecalculateOnInvalidation                                   OFFSET(get<T>, {0x50, 1, 0, 0})
...
public:
	...
	CMember(class UNavigationInvokerComponent*)        InvokerComponent                                            OFFSET(get<T>, {0x2D0, 8, 0, 0})
	DMember(bool)                                      bActAsNavigationInvoker                                     OFFSET(get<bool>, {0x2D8, 1, 1, 0})
	SMember(FNavAgentProperties)                       NavAgentProps                                               OFFSET(getStruct<T>, {0x2E0, 64, 0, 0})
	SMember(FVector)                                   QueryingExtent                                              OFFSET(getStruct<T>, {0x320, 12, 0, 0})
	CMember(class ANavigationData*)                    MyNavData                                                   OFFSET(get<T>, {0x330, 8, 0, 0})
	SMember(FVector)                                   ProjectedLocation                                           OFFSET(getStruct<T>, {0x338, 12, 0, 0})
	DMember(bool)                                      bProjectedLocationValid                                     OFFSET(get<bool>, {0x344, 1, 1, 0})
	DMember(bool)                                      bSearchStart                                                OFFSET(get<bool>, {0x344, 1, 1, 1})
	DMember(float)                                     CostLimitFactor                                             OFFSET(get<float>, {0x348, 4, 0, 0})
	DMember(float)                                     MinimumCostLimit                                            OFFSET(get<float>, {0x34C, 4, 0, 0})
	DMember(bool)                                      bBacktracking                                               OFFSET(get<bool>, {0x350, 1, 1, 0})
	DMember(bool)                                      bUseHierarchicalPathfinding                                 OFFSET(get<bool>, {0x350, 1, 1, 1})
	DMember(bool)                                      bGatherDetailedInfo                                         OFFSET(get<bool>, {0x350, 1, 1, 2})
	DMember(bool)                                      bDrawDistanceToWall                                         OFFSET(get<bool>, {0x350, 1, 1, 3})
	DMember(bool)                                      bShowNodePool                                               OFFSET(get<bool>, {0x350, 1, 1, 4})
	DMember(bool)                                      bShowBestPath                                               OFFSET(get<bool>, {0x350, 1, 1, 5})
	DMember(bool)                                      bShowDiffWithPreviousStep                                   OFFSET(get<bool>, {0x350, 1, 1, 6})
	DMember(bool)                                      bShouldBeVisibleInGame                                      OFFSET(get<bool>, {0x350, 1, 1, 7})
	CMember(TEnumAsByte<ENavCostDisplay>)              CostDisplayMode                                             OFFSET(get<T>, {0x354, 1, 0, 0})
	SMember(FVector2D)                                 TextCanvasOffset                                            OFFSET(getStruct<T>, {0x358, 8, 0, 0})
	DMember(bool)                                      bPathExist                                                  OFFSET(get<bool>, {0x360, 1, 1, 0})
	DMember(bool)                                      bPathIsPartial                                              OFFSET(get<bool>, {0x360, 1, 1, 1})
	DMember(bool)                                      bPathSearchOutOfNodes                                       OFFSET(get<bool>, {0x360, 1, 1, 2})
	DMember(float)                                     PathfindingTime                                             OFFSET(get<float>, {0x364, 4, 0, 0})
	DMember(float)                                     PathCost                                                    OFFSET(get<float>, {0x368, 4, 0, 0})
	DMember(int32_t)                                   PathfindingSteps                                            OFFSET(get<int32_t>, {0x36C, 4, 0, 0})
...
public:
	CMember(TArray<FNavigationLink>)                   Links                                                       OFFSET(get<T>, {0x500, 16, 0, 0})
};

/// Class /Script/NavigationSystem.NavLinkCustomComponent
/// Size: 0x00B0 (0x000110 - 0x0001C0)
...
public:
	DMember(uint32_t)                                  NavLinkUserId                                               OFFSET(get<uint32_t>, {0x118, 4, 0, 0})
	CMember(class UClass*)                             EnabledAreaClass                                            OFFSET(get<T>, {0x120, 8, 0, 0})
	CMember(class UClass*)                             DisabledAreaClass                                           OFFSET(get<T>, {0x128, 8, 0, 0})
	SMember(FNavAgentSelector)                         SupportedAgents                                             OFFSET(getStruct<T>, {0x130, 4, 0, 0})
	SMember(FVector)                                   LinkRelativeStart                                           OFFSET(getStruct<T>, {0x134, 12, 0, 0})
	SMember(FVector)                                   LinkRelativeEnd                                             OFFSET(getStruct<T>, {0x140, 12, 0, 0})
	CMember(TEnumAsByte<ENavLinkDirection>)            LinkDirection                                               OFFSET(get<T>, {0x14C, 1, 0, 0})
	DMember(bool)                                      bLinkEnabled                                                OFFSET(get<bool>, {0x150, 1, 1, 0})
	DMember(bool)                                      bNotifyWhenEnabled                                          OFFSET(get<bool>, {0x150, 1, 1, 1})
	DMember(bool)                                      bNotifyWhenDisabled                                         OFFSET(get<bool>, {0x150, 1, 1, 2})
	DMember(bool)                                      bCreateBoxObstacle                                          OFFSET(get<bool>, {0x150, 1, 1, 3})
	SMember(FVector)                                   ObstacleOffset                                              OFFSET(getStruct<T>, {0x154, 12, 0, 0})
	SMember(FVector)                                   ObstacleExtent                                              OFFSET(getStruct<T>, {0x160, 12, 0, 0})
	CMember(class UClass*)                             ObstacleAreaClass                                           OFFSET(get<T>, {0x170, 8, 0, 0})
	DMember(float)                                     BroadcastRadius                                             OFFSET(get<float>, {0x178, 4, 0, 0})
	DMember(float)                                     BroadcastInterval                                           OFFSET(get<float>, {0x17C, 4, 0, 0})
	CMember(TEnumAsByte<ECollisionChannel>)            BroadcastChannel                                            OFFSET(get<T>, {0x180, 1, 0, 0})
};
...
public:
	SMember(FNavAgentSelector)                         SupportedAgents                                             OFFSET(getStruct<T>, {0x310, 4, 0, 0})
};
...
public:
	...
	SMember(FVector)                                   FailsafeExtent                                              OFFSET(getStruct<T>, {0x118, 12, 0, 0})
	DMember(bool)                                      bIncludeAgentHeight                                         OFFSET(get<bool>, {0x124, 1, 1, 0})
...
public:
	CMember(class UClass*)                             AreaClass                                                   OFFSET(get<T>, {0x318, 8, 0, 0})
	DMember(bool)                                      bMaskFillCollisionUnderneathForNavmesh                      OFFSET(get<bool>, {0x320, 1, 0, 0})
...
public:
	CMember(class UNavigationSystemConfig*)            NavigationSystemConfig                                      OFFSET(get<T>, {0x2B8, 8, 0, 0})
	CMember(ENavSystemOverridePolicy)                  OverridePolicy                                              OFFSET(get<T>, {0x2C0, 1, 0, 0})
	DMember(bool)                                      bLoadOnClient                                               OFFSET(get<bool>, {0x2C1, 1, 1, 0})
};
...
public:
	DMember(bool)                                      bDrawTriangleEdges                                          OFFSET(get<bool>, {0x4E0, 1, 1, 0})
	DMember(bool)                                      bDrawPolyEdges                                              OFFSET(get<bool>, {0x4E0, 1, 1, 1})
	DMember(bool)                                      bDrawFilledPolys                                            OFFSET(get<bool>, {0x4E0, 1, 1, 2})
	DMember(bool)                                      bDrawNavMeshEdges                                           OFFSET(get<bool>, {0x4E0, 1, 1, 3})
	DMember(bool)                                      bDrawTileBounds                                             OFFSET(get<bool>, {0x4E0, 1, 1, 4})
	DMember(bool)                                      bDrawPathCollidingGeometry                                  OFFSET(get<bool>, {0x4E0, 1, 1, 5})
	DMember(bool)                                      bDrawTileLabels                                             OFFSET(get<bool>, {0x4E0, 1, 1, 6})
	DMember(bool)                                      bDrawPolygonLabels                                          OFFSET(get<bool>, {0x4E0, 1, 1, 7})
	DMember(bool)                                      bDrawDefaultPolygonCost                                     OFFSET(get<bool>, {0x4E1, 1, 1, 0})
	DMember(bool)                                      bDrawPolygonFlags                                           OFFSET(get<bool>, {0x4E1, 1, 1, 1})
	DMember(bool)                                      bDrawLabelsOnPathNodes                                      OFFSET(get<bool>, {0x4E1, 1, 1, 2})
	DMember(bool)                                      bDrawNavLinks                                               OFFSET(get<bool>, {0x4E1, 1, 1, 3})
	DMember(bool)                                      bDrawFailedNavLinks                                         OFFSET(get<bool>, {0x4E1, 1, 1, 4})
	DMember(bool)                                      bDrawClusters                                               OFFSET(get<bool>, {0x4E1, 1, 1, 5})
	DMember(bool)                                      bDrawOctree                                                 OFFSET(get<bool>, {0x4E1, 1, 1, 6})
	DMember(bool)                                      bDrawOctreeDetails                                          OFFSET(get<bool>, {0x4E1, 1, 1, 7})
	DMember(bool)                                      bDrawMarkedForbiddenPolys                                   OFFSET(get<bool>, {0x4E2, 1, 1, 0})
	DMember(bool)                                      bDistinctlyDrawTilesBeingBuilt                              OFFSET(get<bool>, {0x4E2, 1, 1, 1})
	DMember(float)                                     DrawOffset                                                  OFFSET(get<float>, {0x4E4, 4, 0, 0})
	DMember(bool)                                      bFixedTilePoolSize                                          OFFSET(get<bool>, {0x4E8, 1, 1, 0})
	DMember(int32_t)                                   TilePoolSize                                                OFFSET(get<int32_t>, {0x4EC, 4, 0, 0})
	DMember(float)                                     TileSizeUU                                                  OFFSET(get<float>, {0x4F0, 4, 0, 0})
	DMember(float)                                     CellSize                                                    OFFSET(get<float>, {0x4F4, 4, 0, 0})
	DMember(float)                                     CellHeight                                                  OFFSET(get<float>, {0x4F8, 4, 0, 0})
	DMember(float)                                     AgentRadius                                                 OFFSET(get<float>, {0x4FC, 4, 0, 0})
	DMember(float)                                     AgentHeight                                                 OFFSET(get<float>, {0x500, 4, 0, 0})
	DMember(float)                                     AgentMaxSlope                                               OFFSET(get<float>, {0x504, 4, 0, 0})
	DMember(float)                                     AgentMaxStepHeight                                          OFFSET(get<float>, {0x508, 4, 0, 0})
	DMember(float)                                     MinRegionArea                                               OFFSET(get<float>, {0x50C, 4, 0, 0})
	DMember(float)                                     MergeRegionSize                                             OFFSET(get<float>, {0x510, 4, 0, 0})
	DMember(float)                                     MaxSimplificationError                                      OFFSET(get<float>, {0x514, 4, 0, 0})
	DMember(int32_t)                                   MaxSimultaneousTileGenerationJobsCount                      OFFSET(get<int32_t>, {0x518, 4, 0, 0})
	DMember(int32_t)                                   TileNumberHardLimit                                         OFFSET(get<int32_t>, {0x51C, 4, 0, 0})
	DMember(int32_t)                                   PolyRefTileBits                                             OFFSET(get<int32_t>, {0x520, 4, 0, 0})
	DMember(int32_t)                                   PolyRefNavPolyBits                                          OFFSET(get<int32_t>, {0x524, 4, 0, 0})
	DMember(int32_t)                                   PolyRefSaltBits                                             OFFSET(get<int32_t>, {0x528, 4, 0, 0})
	SMember(FVector)                                   NavMeshOriginOffset                                         OFFSET(getStruct<T>, {0x52C, 12, 0, 0})
	...
	DMember(bool)                                      bPerformVoxelFiltering                                      OFFSET(get<bool>, {0x550, 1, 1, 1})
	DMember(bool)                                      bMarkLowHeightAreas                                         OFFSET(get<bool>, {0x550, 1, 1, 2})
	DMember(bool)                                      bUseExtraTopCellWhenMarkingAreas                            OFFSET(get<bool>, {0x550, 1, 1, 3})
	DMember(bool)                                      bFilterLowSpanSequences                                     OFFSET(get<bool>, {0x550, 1, 1, 4})
	DMember(bool)                                      bFilterLowSpanFromTileCache                                 OFFSET(get<bool>, {0x550, 1, 1, 5})
	DMember(bool)                                      bDoFullyAsyncNavDataGathering                               OFFSET(get<bool>, {0x550, 1, 1, 6})
	DMember(bool)                                      bUseBetterOffsetsFromCorners                                OFFSET(get<bool>, {0x550, 1, 1, 7})
	DMember(bool)                                      bStoreEmptyTileLayers                                       OFFSET(get<bool>, {0x551, 1, 1, 0})
	DMember(bool)                                      bUseVirtualFilters                                          OFFSET(get<bool>, {0x551, 1, 1, 1})
	DMember(bool)                                      bAllowNavLinkAsPathEnd                                      OFFSET(get<bool>, {0x551, 1, 1, 2})
	DMember(bool)                                      bUseVoxelCache                                              OFFSET(get<bool>, {0x551, 1, 1, 3})
	DMember(float)                                     TileSetUpdateInterval                                       OFFSET(get<float>, {0x554, 4, 0, 0})
	CMember(TArray<class URecastNavMeshDataChunk*>)    ProcessingIncrementalChunkRemovalList                       OFFSET(get<T>, {0x558, 16, 0, 0})
	DMember(float)                                     HeuristicScale                                              OFFSET(get<float>, {0x568, 4, 0, 0})
	DMember(float)                                     VerticalDeviationFromGroundCompensation                     OFFSET(get<float>, {0x56C, 4, 0, 0})
