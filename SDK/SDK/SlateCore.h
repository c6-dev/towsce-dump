...
/// Size: 0x07C8 (1992 bytes) (0x000008 - 0x0007C8) align 8 MaxSize: 0x07C8
...
/// Size: 0x0278 (632 bytes) (0x000008 - 0x000278) align 8 MaxSize: 0x0278
...
/// Size: 0x03B8 (952 bytes) (0x000008 - 0x0003B8) align 8 MaxSize: 0x03B8
...
/// Size: 0x03F0 (1008 bytes) (0x000008 - 0x0003F0) align 8 MaxSize: 0x03F0
...
/// Size: 0x0220 (544 bytes) (0x000008 - 0x000220) align 8 MaxSize: 0x0220
...
/// Size: 0x04D0 (1232 bytes) (0x000008 - 0x0004D0) align 8 MaxSize: 0x04D0
...
/// Size: 0x07F8 (2040 bytes) (0x000008 - 0x0007F8) align 8 MaxSize: 0x07F8
...
{ 
	FSlateFontInfo                                     Font;                                                       // 0x0008   (0x0058)  
	FSlateColor                                        ColorAndOpacity;                                            // 0x0060   (0x0028)  
	bool                                               bAllowManualColorChanging;                                  // 0x0088   (0x0001)  
	unsigned char                                      UnknownData00_6[0x3];                                       // 0x0089   (0x0003)  MISSED
	FVector2D                                          ShadowOffset;                                               // 0x008C   (0x0008)  
	FLinearColor                                       ShadowColorAndOpacity;                                      // 0x0094   (0x0010)  
	...
	FSlateBrush                                        HighlightShape;                                             // 0x00E0   (0x0088)  
	FSlateBrush                                        StrikeBrush;                                                // 0x0168   (0x0088)  
	FSlateBrush                                        UnderlineBrush;                                             // 0x01F0   (0x0088)  
};

/// Struct /Script/SlateCore.SpinBoxStyle
/// Size: 0x02E8 (744 bytes) (0x000008 - 0x0002E8) align 8 MaxSize: 0x02E8
...
/// Size: 0x1068 (4200 bytes) (0x000008 - 0x001068) align 8 MaxSize: 0x1068
...
{ 
	...
	FTextBlockStyle                                    TitleTextStyle;                                             // 0x09E8   (0x0278)  
	FSlateBrush                                        ActiveTitleBrush;                                           // 0x0C60   (0x0088)  
	FSlateBrush                                        InactiveTitleBrush;                                         // 0x0CE8   (0x0088)  
	FSlateBrush                                        FlashTitleBrush;                                            // 0x0D70   (0x0088)  
	FSlateColor                                        BackgroundColor;                                            // 0x0DF8   (0x0028)  
	FSlateBrush                                        OutlineBrush;                                               // 0x0E20   (0x0088)  
	FSlateColor                                        OutlineColor;                                               // 0x0EA8   (0x0028)  
	FSlateBrush                                        BorderBrush;                                                // 0x0ED0   (0x0088)  
	FSlateBrush                                        BackgroundBrush;                                            // 0x0F58   (0x0088)  
	FSlateBrush                                        ChildBackgroundBrush;                                       // 0x0FE0   (0x0088)  
};

/// Struct /Script/SlateCore.ScrollBorderStyle
/// Size: 0x0118 (280 bytes) (0x000008 - 0x000118) align 8 MaxSize: 0x0118
...
/// Size: 0x0228 (552 bytes) (0x000008 - 0x000228) align 8 MaxSize: 0x0228
...
/// Size: 0x0700 (1792 bytes) (0x000008 - 0x000700) align 8 MaxSize: 0x0700
...
/// Size: 0x0B70 (2928 bytes) (0x000008 - 0x000B70) align 8 MaxSize: 0x0B70
...
/// Size: 0x0348 (840 bytes) (0x000008 - 0x000348) align 8 MaxSize: 0x0348
...
{ 
	...
	float                                              SliderIndentation;                                          // 0x033C   (0x0004)  
	bool                                               bUseSliderIndentation;                                      // 0x0340   (0x0001)  
	unsigned char                                      UnknownData00_7[0x7];                                       // 0x0341   (0x0007)  MISSED
};

/// Struct /Script/SlateCore.VolumeControlStyle
/// Size: 0x05F8 (1528 bytes) (0x000008 - 0x0005F8) align 8 MaxSize: 0x05F8
struct FVolumeControlStyle : FSlateWidgetStyle
{ 
	FSliderStyle                                       SliderStyle;                                                // 0x0008   (0x0348)  
	FSlateBrush                                        HighVolumeImage;                                            // 0x0350   (0x0088)  
	FSlateBrush                                        MidVolumeImage;                                             // 0x03D8   (0x0088)  
	FSlateBrush                                        LowVolumeImage;                                             // 0x0460   (0x0088)  
	FSlateBrush                                        NoVolumeImage;                                              // 0x04E8   (0x0088)  
	FSlateBrush                                        MutedImage;                                                 // 0x0570   (0x0088)  
};

/// Struct /Script/SlateCore.SearchBoxStyle
/// Size: 0x0A90 (2704 bytes) (0x000008 - 0x000A90) align 8 MaxSize: 0x0A90
...
/// Size: 0x0120 (288 bytes) (0x000008 - 0x000120) align 8 MaxSize: 0x0120
...
/// Size: 0x01A0 (416 bytes) (0x000008 - 0x0001A0) align 8 MaxSize: 0x01A0
...
/// Size: 0x0A78 (2680 bytes) (0x000008 - 0x000A78) align 8 MaxSize: 0x0A78
struct FInlineEditableTextBlockStyle : FSlateWidgetStyle
{ 
	FEditableTextBoxStyle                              EditableTextBoxStyle;                                       // 0x0008   (0x07F8)  
	FTextBlockStyle                                    TextStyle;                                                  // 0x0800   (0x0278)  
};

/// Struct /Script/SlateCore.HyperlinkStyle
/// Size: 0x0508 (1288 bytes) (0x000008 - 0x000508) align 8 MaxSize: 0x0508
struct FHyperlinkStyle : FSlateWidgetStyle
{ 
	FButtonStyle                                       UnderlineStyle;                                             // 0x0008   (0x0278)  
	FTextBlockStyle                                    TextStyle;                                                  // 0x0280   (0x0278)  
	FMargin                                            Padding;                                                    // 0x04F8   (0x0010)  
};

/// Struct /Script/SlateCore.CheckBoxStyle
/// Size: 0x0580 (1408 bytes) (0x000008 - 0x000580) align 8 MaxSize: 0x0580
...
static_assert(sizeof(USlateWidgetStyleContainerBase) == 0x0038); // 56 bytes (0x000030 - 0x000038)
static_assert(sizeof(UFontBulkData) == 0x0080); // 128 bytes (0x000030 - 0x000080)
static_assert(sizeof(UFontFaceInterface) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UFontProviderInterface) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(USlateTypes) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(USlateWidgetStyleAsset) == 0x0038); // 56 bytes (0x000030 - 0x000038)
static_assert(sizeof(USlateWidgetStyleContainerInterface) == 0x0030); // 48 bytes (0x000030 - 0x000030)
...
static_assert(sizeof(FTextBlockStyle) == 0x0278); // 632 bytes (0x000008 - 0x000278)
...
static_assert(sizeof(FWindowStyle) == 0x1068); // 4200 bytes (0x000008 - 0x001068)
...
static_assert(sizeof(FSliderStyle) == 0x0348); // 840 bytes (0x000008 - 0x000348)
static_assert(sizeof(FVolumeControlStyle) == 0x05F8); // 1528 bytes (0x000008 - 0x0005F8)
...
static_assert(sizeof(FInlineEditableTextBlockStyle) == 0x0A78); // 2680 bytes (0x000008 - 0x000A78)
static_assert(sizeof(FHyperlinkStyle) == 0x0508); // 1288 bytes (0x000008 - 0x000508)
static_assert(sizeof(FCheckBoxStyle) == 0x0580); // 1408 bytes (0x000008 - 0x000580)
static_assert(offsetof(USlateWidgetStyleAsset, CustomStyle) == 0x0030);
...
static_assert(offsetof(FTextBlockStyle, ShadowOffset) == 0x008C);
static_assert(offsetof(FTextBlockStyle, ShadowColorAndOpacity) == 0x0094);
...
static_assert(offsetof(FTextBlockStyle, UnderlineBrush) == 0x01F0);
...
static_assert(offsetof(FWindowStyle, ActiveTitleBrush) == 0x0C60);
static_assert(offsetof(FWindowStyle, InactiveTitleBrush) == 0x0CE8);
static_assert(offsetof(FWindowStyle, FlashTitleBrush) == 0x0D70);
static_assert(offsetof(FWindowStyle, BackgroundColor) == 0x0DF8);
static_assert(offsetof(FWindowStyle, OutlineBrush) == 0x0E20);
static_assert(offsetof(FWindowStyle, OutlineColor) == 0x0EA8);
static_assert(offsetof(FWindowStyle, BorderBrush) == 0x0ED0);
static_assert(offsetof(FWindowStyle, BackgroundBrush) == 0x0F58);
static_assert(offsetof(FWindowStyle, ChildBackgroundBrush) == 0x0FE0);
...
static_assert(offsetof(FVolumeControlStyle, HighVolumeImage) == 0x0350);
static_assert(offsetof(FVolumeControlStyle, MidVolumeImage) == 0x03D8);
static_assert(offsetof(FVolumeControlStyle, LowVolumeImage) == 0x0460);
static_assert(offsetof(FVolumeControlStyle, NoVolumeImage) == 0x04E8);
static_assert(offsetof(FVolumeControlStyle, MutedImage) == 0x0570);
...
static_assert(offsetof(FHyperlinkStyle, Padding) == 0x04F8);
