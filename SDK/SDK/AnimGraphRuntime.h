...
public:
	...
	// void K2_TwoBoneIK(FVector& RootPos, FVector& JointPos, FVector& EndPos, FVector& JointTarget, FVector& Effector, FVector& OutJointPos, FVector& OutEndPos, bool bAllowStretching, float StartStretchRatio, float MaxStretchScale); // [0x2deaf20] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_StartProfilingTimer
	// void K2_StartProfilingTimer();                                                                                           // [0x2deaf00] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_MakePerlinNoiseVectorAndRemap
	// FVector K2_MakePerlinNoiseVectorAndRemap(float X, float Y, float Z, float RangeOutMinX, float RangeOutMaxX, float RangeOutMinY, float RangeOutMaxY, float RangeOutMinZ, float RangeOutMaxZ); // [0x2deac20] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_MakePerlinNoiseAndRemap
	// float K2_MakePerlinNoiseAndRemap(float Value, float RangeOutMin, float RangeOutMax);                                     // [0x2deab00] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_LookAt
	// FTransform K2_LookAt(FTransform& CurrentTransform, FVector& TargetPosition, FVector LookAtVector, bool bUseUpVector, FVector UpVector, float ClampConeInDegree); // [0x2dea860] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_EndProfilingTimer
	// float K2_EndProfilingTimer(bool bLog, FString LogPrefix);                                                                // [0x2dea770] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_DistanceBetweenTwoSocketsAndMapRange
	// float K2_DistanceBetweenTwoSocketsAndMapRange(class USkeletalMeshComponent* Component, FName SocketOrBoneNameA, TEnumAsByte<ERelativeTransformSpace> SocketSpaceA, FName SocketOrBoneNameB, TEnumAsByte<ERelativeTransformSpace> SocketSpaceB, bool bRemapRange, float InRangeMin, float InRangeMax, float OutRangeMin, float OutRangeMax); // [0x2dea480] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_DirectionBetweenSockets
	// FVector K2_DirectionBetweenSockets(class USkeletalMeshComponent* Component, FName SocketOrBoneNameFrom, FName SocketOrBoneNameTo); // [0x2dea370] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_CalculateVelocityFromSockets
	// float K2_CalculateVelocityFromSockets(float DeltaSeconds, class USkeletalMeshComponent* Component, FName SocketOrBoneName, FName ReferenceSocketOrBone, TEnumAsByte<ERelativeTransformSpace> SocketSpace, FVector OffsetInBoneSpace, FPositionHistory& History, int32_t NumberOfSamples, float VelocityMin, float VelocityMax, EEasingFuncType EasingType, FRuntimeFloatCurve& CustomCurve); // [0x2de9f10] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_CalculateVelocityFromPositionHistory
	// float K2_CalculateVelocityFromPositionHistory(float DeltaSeconds, FVector Position, FPositionHistory& History, int32_t NumberOfSamples, float VelocityMin, float VelocityMax); // [0x2de9cf0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,310) /* FMulticastInlineDelegate */ __um(OnCompleted);                                        // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,311) /* FMulticastInlineDelegate */ __um(OnBlendOut);                                         // 0x0040   (0x0010)  
	SDK_UNDEFINED(16,312) /* FMulticastInlineDelegate */ __um(OnInterrupted);                                      // 0x0050   (0x0010)  
	SDK_UNDEFINED(16,313) /* FMulticastInlineDelegate */ __um(OnNotifyBegin);                                      // 0x0060   (0x0010)  
	SDK_UNDEFINED(16,314) /* FMulticastInlineDelegate */ __um(OnNotifyEnd);                                        // 0x0070   (0x0010)  
	...
	// void OnNotifyEndReceived(FName NotifyName, FBranchingPointNotifyPayload& BranchingPointNotifyPayload);                   // [0x2dec290] Final|Native|Protected|HasOutParms 
	// Function /Script/AnimGraphRuntime.PlayMontageCallbackProxy.OnNotifyBeginReceived
	// void OnNotifyBeginReceived(FName NotifyName, FBranchingPointNotifyPayload& BranchingPointNotifyPayload);                 // [0x2dec1a0] Final|Native|Protected|HasOutParms 
	// Function /Script/AnimGraphRuntime.PlayMontageCallbackProxy.OnMontageEnded
	// void OnMontageEnded(class UAnimMontage* Montage, bool bInterrupted);                                                     // [0x2dec0d0] Final|Native|Protected 
	// Function /Script/AnimGraphRuntime.PlayMontageCallbackProxy.OnMontageBlendingOut
	// void OnMontageBlendingOut(class UAnimMontage* Montage, bool bInterrupted);                                               // [0x2dec000] Final|Native|Protected 
	// Function /Script/AnimGraphRuntime.PlayMontageCallbackProxy.CreateProxyObjectForPlayMontage
	// class UPlayMontageCallbackProxy* CreateProxyObjectForPlayMontage(class USkeletalMeshComponent* InSkeletalMeshComponent, class UAnimMontage* MontageToPlay, float PlayRate, float StartingPosition, FName StartingSection); // [0x2debe70] Final|Native|Static|Public|BlueprintCallable 
};
...
/// Size: 0x0A10 (2576 bytes) (0x000770 - 0x000A10) align 16 MaxSize: 0x0A10
...
{ 
	...
	bool                                               bForceResetPlayTime;                                        // 0x0058   (0x0001)  
	unsigned char                                      UnknownData01_6[0x8F];                                      // 0x0059   (0x008F)  MISSED
	class UBlendSpaceBase*                             PreviousBlendSpace;                                         // 0x00E8   (0x0008)  
};
...
{ 
	unsigned char                                      UnknownData00_8[0x60];                                      // 0x00F0   (0x0060)  MISSED
...
/// Size: 0x0440 (1088 bytes) (0x0000C8 - 0x000440) align 16 MaxSize: 0x0440
...
/// Size: 0x0118 (280 bytes) (0x0000C8 - 0x000118) align 8 MaxSize: 0x0118
...
/// Size: 0x0180 (384 bytes) (0x0000C8 - 0x000180) align 16 MaxSize: 0x0180
...
/// Size: 0x0108 (264 bytes) (0x0000C8 - 0x000108) align 8 MaxSize: 0x0108
...
/// Size: 0x00F0 (240 bytes) (0x0000C8 - 0x0000F0) align 8 MaxSize: 0x00F0
...
/// Size: 0x00F8 (248 bytes) (0x0000C8 - 0x0000F8) align 8 MaxSize: 0x00F8
...
/// Size: 0x01D8 (472 bytes) (0x000010 - 0x0001D8) align 8 MaxSize: 0x01D8
...
{ 
	...
	SDK_UNDEFINED(16,315) /* TScriptInterface<Class> */ __um(CurveSource);                                         // 0x0030   (0x0010)  
};
...
/// Size: 0x0120 (288 bytes) (0x0000C8 - 0x000120) align 8 MaxSize: 0x0120
...
/// Size: 0x00C0 (192 bytes) (0x000010 - 0x0000C0) align 8 MaxSize: 0x00C0
...
/// Size: 0x0168 (360 bytes) (0x000080 - 0x000168) align 8 MaxSize: 0x0168
...
{ 
	...
	bool                                               bShuffleMode;                                               // 0x0078   (0x0001)  
...
/// Size: 0x0830 (2096 bytes) (0x0000C8 - 0x000830) align 16 MaxSize: 0x0830
...
/// Size: 0x0198 (408 bytes) (0x0000F0 - 0x000198) align 8 MaxSize: 0x0198
...
{ 
	...
	unsigned char                                      UnknownData00_6[0x4];                                       // 0x0190   (0x0004)  MISSED
	EAnimAlphaInputType                                AlphaInputType;                                             // 0x0194   (0x0001)  
	bool                                               bAlphaBoolEnabled;                                          // 0x0195   (0x0001)  
	unsigned char                                      UnknownData01_7[0x2];                                       // 0x0196   (0x0002)  MISSED
};
...
/// Size: 0x0048 (72 bytes) (0x000010 - 0x000048) align 8 MaxSize: 0x0048
...
/// Size: 0x0270 (624 bytes) (0x0000C8 - 0x000270) align 8 MaxSize: 0x0270
...
/// Size: 0x0128 (296 bytes) (0x0000C8 - 0x000128) align 8 MaxSize: 0x0128
...
/// Size: 0x0260 (608 bytes) (0x0000C8 - 0x000260) align 16 MaxSize: 0x0260
struct FAnimNode_Trail : FAnimNode_SkeletalControlBase
{ 
	unsigned char                                      UnknownData00_8[0x38];                                      // 0x00C8   (0x0038)  MISSED
...
static_assert(sizeof(UAnimNotify_PlayMontageNotify) == 0x0048); // 72 bytes (0x000040 - 0x000048)
static_assert(sizeof(UAnimNotify_PlayMontageNotifyWindow) == 0x0040); // 64 bytes (0x000038 - 0x000040)
static_assert(sizeof(UKismetAnimationLibrary) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UPlayMontageCallbackProxy) == 0x00B0); // 176 bytes (0x000030 - 0x0000B0)
static_assert(sizeof(USequencerAnimationSupport) == 0x0030); // 48 bytes (0x000030 - 0x000030)
...
static_assert(sizeof(FAnimNode_BlendSpacePlayer) == 0x00F0); // 240 bytes (0x000038 - 0x0000F0)
...
static_assert(sizeof(FAnimNode_RandomPlayer) == 0x0080); // 128 bytes (0x000010 - 0x000080)
...
static_assert(offsetof(UAnimNotify_PlayMontageNotify, NotifyName) == 0x0040);
static_assert(offsetof(UAnimNotify_PlayMontageNotifyWindow, NotifyName) == 0x0038);
