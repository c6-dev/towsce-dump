...
{ 
public:
	FMovieSceneGeometryCollectionParams                Params;                                                     // 0x00F0   (0x0030)  
};
...
static_assert(sizeof(UMovieSceneGeometryCollectionSection) == 0x0120); // 288 bytes (0x0000F0 - 0x000120)
static_assert(sizeof(UMovieSceneGeometryCollectionTrack) == 0x00B0); // 176 bytes (0x000098 - 0x0000B0)
...
static_assert(offsetof(UMovieSceneGeometryCollectionSection, Params) == 0x00F0);
static_assert(offsetof(UMovieSceneGeometryCollectionTrack, AnimationSections) == 0x00A0);
