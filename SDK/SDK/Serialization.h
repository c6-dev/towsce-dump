...
{ 
	...
	TSoftObjectPtr<class UClass*>                      SoftClass;                                                  // 0x0010   (0x0028)  
	class UObject*                                     Object;                                                     // 0x0038   (0x0008)  
	TWeakObjectPtr<class UMetaData*>                   WeakObject;                                                 // 0x0040   (0x0008)  
	TWeakObjectPtr<class UMetaData*>                   SoftObject;                                                 // 0x0048   (0x0008)  
...
{ 
	SDK_UNDEFINED(80,889) /* TSet<FString> */          __um(StrSet);                                               // 0x0000   (0x0050)  
	SDK_UNDEFINED(80,890) /* TSet<int32_t> */          __um(IntSet);                                               // 0x0050   (0x0050)  
	SDK_UNDEFINED(80,891) /* TSet<FName> */            __um(NameSet);                                              // 0x00A0   (0x0050)  
	SDK_UNDEFINED(80,892) /* TSet<FStructSerializerBuiltinTestStruct> */ __um(StructSet);                          // 0x00F0   (0x0050)  
};

/// Struct /Script/Serialization.StructSerializerTestStruct
/// Size: 0x0450 (1104 bytes) (0x000000 - 0x000450) align 16 MaxSize: 0x0450
