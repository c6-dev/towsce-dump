...
/// Size: 0x00E0 (224 bytes) (0x000018 - 0x0000E0) align 16 MaxSize: 0x00E0
...
/// Size: 0x02F0 (752 bytes) (0x000018 - 0x0002F0) align 16 MaxSize: 0x02F0
...
/// Size: 0x0368 (872 bytes) (0x000000 - 0x000368) align 8 MaxSize: 0x0368
...
/// Size: 0x0658 (1624 bytes) (0x000030 - 0x000658) align 8 MaxSize: 0x0658
class UControlRig : public UObject
{ 
public:
	unsigned char                                      UnknownData00_8[0x1D];                                      // 0x0030   (0x001D)  MISSED
	...
	unsigned char                                      UnknownData02_6[0x30];                                      // 0x03C8   (0x0030)  MISSED
	...
	unsigned char                                      UnknownData03_6[0x18];                                      // 0x04B0   (0x0018)  MISSED
	class UAnimationDataSourceRegistry*                DataSourceRegistry;                                         // 0x04C8   (0x0008)  
	TArray<FName>                                      EventQueue;                                                 // 0x04D0   (0x0010)  
	unsigned char                                      UnknownData04_6[0x78];                                      // 0x04E0   (0x0078)  MISSED
	...
	unsigned char                                      UnknownData05_7[0x80];                                      // 0x05D8   (0x0080)  MISSED


	/// Functions
	// Function /Script/ControlRig.ControlRig.SetInteractionRigClass
	// void SetInteractionRigClass(class UClass* InInteractionRigClass);                                                        // [0xd488e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRig.SetInteractionRig
	// void SetInteractionRig(class UControlRig* InInteractionRig);                                                             // [0xd48850] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRig.GetInteractionRigClass
	// class UClass* GetInteractionRigClass();                                                                                  // [0xd474a0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ControlRig.ControlRig.GetInteractionRig
	// class UControlRig* GetInteractionRig();                                                                                  // [0xd47480] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
public:
	unsigned char                                      UnknownData00_1[0x10];                                      // 0x0658   (0x0010)  MISSED
};
...
/// Size: 0x05E0 (1504 bytes) (0x0004F8 - 0x0005E0) align 16 MaxSize: 0x05E0
class UControlRigComponent : public UPrimitiveComponent
{ 
public:
	class UClass*                                      ControlRigClass;                                            // 0x04F8   (0x0008)  
	SDK_UNDEFINED(16,766) /* FMulticastInlineDelegate */ __um(OnPostInitializeDelegate);                           // 0x0500   (0x0010)  
	SDK_UNDEFINED(16,767) /* FMulticastInlineDelegate */ __um(OnPreSetupDelegate);                                 // 0x0510   (0x0010)  
	SDK_UNDEFINED(16,768) /* FMulticastInlineDelegate */ __um(OnPostSetupDelegate);                                // 0x0520   (0x0010)  
	SDK_UNDEFINED(16,769) /* FMulticastInlineDelegate */ __um(OnPreUpdateDelegate);                                // 0x0530   (0x0010)  
	SDK_UNDEFINED(16,770) /* FMulticastInlineDelegate */ __um(OnPostUpdateDelegate);                               // 0x0540   (0x0010)  
	TArray<FControlRigComponentMappedElement>          MappedElements;                                             // 0x0550   (0x0010)  
	bool                                               bResetTransformBeforeTick;                                  // 0x0560   (0x0001)  
	bool                                               bResetInitialsBeforeSetup;                                  // 0x0561   (0x0001)  
	bool                                               bUpdateRigOnTick;                                           // 0x0562   (0x0001)  
	bool                                               bUpdateInEditor;                                            // 0x0563   (0x0001)  
	bool                                               bDrawBones;                                                 // 0x0564   (0x0001)  
	bool                                               bShowDebugDrawing;                                          // 0x0565   (0x0001)  
	unsigned char                                      UnknownData00_6[0x2];                                       // 0x0566   (0x0002)  MISSED
	class UControlRig*                                 ControlRig;                                                 // 0x0568   (0x0008)  
	unsigned char                                      UnknownData01_7[0x70];                                      // 0x0570   (0x0070)  MISSED


	/// Functions
	// Function /Script/ControlRig.ControlRigComponent.Update
	// void Update(float DeltaTime);                                                                                            // [0xd48a60] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetMappedElements
	// void SetMappedElements(TArray<FControlRigComponentMappedElement> NewMappedElements);                                     // [0xd48970] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetInitialSpaceTransform
	// void SetInitialSpaceTransform(FName SpaceName, FTransform InitialTransform, EControlRigComponentSpace Space);            // [0xd486c0] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetInitialBoneTransform
	// void SetInitialBoneTransform(FName BoneName, FTransform InitialTransform, EControlRigComponentSpace Space, bool bPropagateToChildren); // [0xd48510] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetControlVector2D
	// void SetControlVector2D(FName ControlName, FVector2D Value);                                                             // [0xd48440] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetControlTransform
	// void SetControlTransform(FName ControlName, FTransform Value, EControlRigComponentSpace Space);                          // [0xd482b0] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetControlScale
	// void SetControlScale(FName ControlName, FVector Value, EControlRigComponentSpace Space);                                 // [0xd48190] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetControlRotator
	// void SetControlRotator(FName ControlName, FRotator Value, EControlRigComponentSpace Space);                              // [0xd48070] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetControlPosition
	// void SetControlPosition(FName ControlName, FVector Value, EControlRigComponentSpace Space);                              // [0xd47f50] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetControlOffset
	// void SetControlOffset(FName ControlName, FTransform OffsetTransform, EControlRigComponentSpace Space);                   // [0xd47dc0] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetControlInt
	// void SetControlInt(FName ControlName, int32_t Value);                                                                    // [0xd47cf0] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetControlFloat
	// void SetControlFloat(FName ControlName, float Value);                                                                    // [0xd47c20] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetControlBool
	// void SetControlBool(FName ControlName, bool Value);                                                                      // [0xd47b50] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetBoneTransform
	// void SetBoneTransform(FName BoneName, FTransform Transform, EControlRigComponentSpace Space, float Weight, bool bPropagateToChildren); // [0xd47950] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetBoneInitialTransformsFromSkeletalMesh
	// void SetBoneInitialTransformsFromSkeletalMesh(class USkeletalMesh* InSkeletalMesh);                                      // [0xd478c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.OnPreUpdate
	// void OnPreUpdate(class UControlRigComponent* Component);                                                                 // [0xd47830] Native|Event|Public|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigComponent.OnPreSetup
	// void OnPreSetup(class UControlRigComponent* Component);                                                                  // [0xd477a0] Native|Event|Public|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigComponent.OnPostUpdate
	// void OnPostUpdate(class UControlRigComponent* Component);                                                                // [0xd47710] Native|Event|Public|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigComponent.OnPostSetup
	// void OnPostSetup(class UControlRigComponent* Component);                                                                 // [0xd47680] Native|Event|Public|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigComponent.OnPostInitialize
	// void OnPostInitialize(class UControlRigComponent* Component);                                                            // [0xd475f0] Native|Event|Public|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigComponent.Initialize
	// void Initialize();                                                                                                       // [0xd475d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.GetSpaceTransform
	// FTransform GetSpaceTransform(FName SpaceName, EControlRigComponentSpace Space);                                          // [0xd474c0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetInitialSpaceTransform
	// FTransform GetInitialSpaceTransform(FName SpaceName, EControlRigComponentSpace Space);                                   // [0xd47370] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetInitialBoneTransform
	// FTransform GetInitialBoneTransform(FName BoneName, EControlRigComponentSpace Space);                                     // [0xd47260] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetElementNames
	// TArray<FName> GetElementNames(ERigElementType ElementType);                                                              // [0xd47180] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetControlVector2D
	// FVector2D GetControlVector2D(FName ControlName);                                                                         // [0xd470f0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetControlTransform
	// FTransform GetControlTransform(FName ControlName, EControlRigComponentSpace Space);                                      // [0xd46fe0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetControlScale
	// FVector GetControlScale(FName ControlName, EControlRigComponentSpace Space);                                             // [0xd46f00] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetControlRotator
	// FRotator GetControlRotator(FName ControlName, EControlRigComponentSpace Space);                                          // [0xd46e20] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetControlRig
	// class UControlRig* GetControlRig();                                                                                      // [0xd46df0] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetControlPosition
	// FVector GetControlPosition(FName ControlName, EControlRigComponentSpace Space);                                          // [0xd46d10] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetControlOffset
	// FTransform GetControlOffset(FName ControlName, EControlRigComponentSpace Space);                                         // [0xd46c00] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.GetControlInt
	// int32_t GetControlInt(FName ControlName);                                                                                // [0xd46b60] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetControlFloat
	// float GetControlFloat(FName ControlName);                                                                                // [0xd46ac0] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetControlBool
	// bool GetControlBool(FName ControlName);                                                                                  // [0xd46a20] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetBoneTransform
	// FTransform GetBoneTransform(FName BoneName, EControlRigComponentSpace Space);                                            // [0xd46910] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetAbsoluteTime
	// float GetAbsoluteTime();                                                                                                 // [0xd468e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ControlRig.ControlRigComponent.DoesElementExist
	// bool DoesElementExist(FName Name, ERigElementType ElementType);                                                          // [0xd46810] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.ClearMappedElements
	// void ClearMappedElements();                                                                                              // [0xd467f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.AddMappedSkeletalMesh
	// void AddMappedSkeletalMesh(class USkeletalMeshComponent* SkeletalMeshComponent, TArray<FControlRigComponentMappedBone> Bones, TArray<FControlRigComponentMappedCurve> Curves); // [0xd46640] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.AddMappedElements
	// void AddMappedElements(TArray<FControlRigComponentMappedElement> NewMappedElements);                                     // [0xd46550] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.AddMappedComponents
	// void AddMappedComponents(TArray<FControlRigComponentMappedComponent> Components);                                        // [0xd46460] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.AddMappedCompleteSkeletalMesh
	// void AddMappedCompleteSkeletalMesh(class USkeletalMeshComponent* SkeletalMeshComponent);                                 // [0xd463d0] Final|Native|Public|BlueprintCallable 
};
...
{ 
public:
	class AActor*                                      ActorToTrack;                                               // 0x02B8   (0x0008)  
	class UClass*                                      ControlRigClass;                                            // 0x02C0   (0x0008)  
	bool                                               bRefreshOnTick;                                             // 0x02C8   (0x0001)  
	bool                                               bIsSelectable;                                              // 0x02C9   (0x0001)  
	unsigned char                                      UnknownData00_6[0x6];                                       // 0x02CA   (0x0006)  MISSED
	class UMaterialInterface*                          MaterialOverride;                                           // 0x02D0   (0x0008)  
	FString                                            ColorParameter;                                             // 0x02D8   (0x0010)  
	bool                                               bCastShadows;                                               // 0x02E8   (0x0001)  
	unsigned char                                      UnknownData01_6[0x7];                                       // 0x02E9   (0x0007)  MISSED
	class USceneComponent*                             ActorRootComponent;                                         // 0x02F0   (0x0008)  
	class UControlRig*                                 ControlRig;                                                 // 0x02F8   (0x0008)  
	TArray<FName>                                      ControlNames;                                               // 0x0300   (0x0010)  
	TArray<FTransform>                                 GizmoTransforms;                                            // 0x0310   (0x0010)  
	...
	unsigned char                                      UnknownData02_7[0x8];                                       // 0x0348   (0x0008)  MISSED


	/// Functions
	// Function /Script/ControlRig.ControlRigControlActor.Refresh
	// void Refresh();                                                                                                          // [0xd4e690] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigControlActor.Clear
	// void Clear();                                                                                                            // [0xd4e580] Final|Native|Public|BlueprintCallable 
};
...
{ 
public:
	class USceneComponent*                             ActorRootComponent;                                         // 0x02B8   (0x0008)  
	class UStaticMeshComponent*                        StaticMeshComponent;                                        // 0x02C0   (0x0008)  
	uint32_t                                           ControlRigIndex;                                            // 0x02C8   (0x0004)  
	FName                                              ControlName;                                                // 0x02CC   (0x0008)  
	FName                                              ColorParameterName;                                         // 0x02D4   (0x0008)  
	bool                                               bEnabled : 1;                                               // 0x02DC:0 (0x0001)  
	bool                                               bSelected : 1;                                              // 0x02DC:1 (0x0001)  
	bool                                               bSelectable : 1;                                            // 0x02DC:2 (0x0001)  
	bool                                               bHovered : 1;                                               // 0x02DC:3 (0x0001)  
	unsigned char                                      UnknownData00_7[0x3];                                       // 0x02DD   (0x0003)  MISSED


	/// Functions
	// Function /Script/ControlRig.ControlRigGizmoActor.SetSelected
	// void SetSelected(bool bInSelected);                                                                                      // [0xd4e940] Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigGizmoActor.SetSelectable
	// void SetSelectable(bool bInSelectable);                                                                                  // [0xd4e8b0] Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigGizmoActor.SetHovered
	// void SetHovered(bool bInHovered);                                                                                        // [0xd4e820] Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigGizmoActor.SetGlobalTransform
	// void SetGlobalTransform(FTransform& InTransform);                                                                        // [0xd4e740] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigGizmoActor.SetEnabled
	// void SetEnabled(bool bInEnabled);                                                                                        // [0xd4e6b0] Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigGizmoActor.OnTransformChanged
	// void OnTransformChanged(FTransform& NewTransform);                                                                       // [0x1c5deb0] Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigGizmoActor.OnSelectionChanged
	// void OnSelectionChanged(bool bIsSelected);                                                                               // [0x1c5deb0] Event|Public|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigGizmoActor.OnManipulatingChanged
	// void OnManipulatingChanged(bool bIsManipulating);                                                                        // [0x1c5deb0] Event|Public|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigGizmoActor.OnHoveredChanged
	// void OnHoveredChanged(bool bIsSelected);                                                                                 // [0x1c5deb0] Event|Public|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigGizmoActor.OnEnabledChanged
	// void OnEnabledChanged(bool bIsEnabled);                                                                                  // [0x1c5deb0] Event|Public|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigGizmoActor.IsSelectedInEditor
	// bool IsSelectedInEditor();                                                                                               // [0xd4e660] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ControlRig.ControlRigGizmoActor.IsHovered
	// bool IsHovered();                                                                                                        // [0xd4e630] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ControlRig.ControlRigGizmoActor.IsEnabled
	// bool IsEnabled();                                                                                                        // [0xd4e600] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ControlRig.ControlRigGizmoActor.GetGlobalTransform
	// FTransform GetGlobalTransform();                                                                                         // [0xd4e5a0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
};
...
/// Size: 0x00E0 (224 bytes) (0x000030 - 0x0000E0) align 16 MaxSize: 0x00E0
...
public:
	...
	FName                                              EventNameA;                                                 // 0x0044   (0x0008)  
	FName                                              EventNameB;                                                 // 0x004C   (0x0008)  
	unsigned char                                      UnknownData01_6[0x4];                                       // 0x0054   (0x0004)  MISSED
	FRigPose                                           Pose;                                                       // 0x0058   (0x0010)  
};
...
/// Size: 0x0228 (552 bytes) (0x0001D0 - 0x000228) align 8 MaxSize: 0x0228
class UControlRigSequence : public ULevelSequence
{ 
public:
	TWeakObjectPtr<class UAnimSequence*>               LastExportedToAnimationSequence;                            // 0x01D0   (0x0008)  
	unsigned char                                      UnknownData00_6[0x20];                                      // 0x01D8   (0x0020)  MISSED
	TWeakObjectPtr<class USkeletalMesh*>               LastExportedUsingSkeletalMesh;                              // 0x01F8   (0x0008)  
	unsigned char                                      UnknownData01_6[0x20];                                      // 0x0200   (0x0020)  MISSED
	float                                              LastExportedFrameRate;                                      // 0x0220   (0x0004)  
	unsigned char                                      UnknownData02_7[0x4];                                       // 0x0224   (0x0004)  MISSED
};

/// Class /Script/ControlRig.ControlRigSequencerAnimInstance
/// Size: 0x02E0 (736 bytes) (0x0002D0 - 0x0002E0) align 16 MaxSize: 0x02E0
class UControlRigSequencerAnimInstance : public UAnimSequencerInstance
{ 
public:
	unsigned char                                      UnknownData00_1[0x10];                                      // 0x02D0   (0x0010)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData00_7[0x7];                                       // 0x0669   (0x0007)  MISSED
};
...
/// Size: 0x02F0 (752 bytes) (0x000150 - 0x0002F0) align 8 MaxSize: 0x02F0
class UMovieSceneControlRigParameterSection : public UMovieSceneParameterSection
{ 
public:
	class UControlRig*                                 ControlRig;                                                 // 0x0150   (0x0008)  
	class UClass*                                      ControlRigClass;                                            // 0x0158   (0x0008)  
	TArray<bool>                                       ControlsMask;                                               // 0x0160   (0x0010)  
	FMovieSceneTransformMask                           TransformMask;                                              // 0x0170   (0x0004)  
...
public:
	...
	class UControlRig*                                 ControlRig;                                                 // 0x00A8   (0x0008)  
	class UMovieSceneSection*                          SectionToKey;                                               // 0x00B0   (0x0008)  
...
/// Size: 0x0368 (872 bytes) (0x000170 - 0x000368) align 8 MaxSize: 0x0368
...
/// Size: 0x0178 (376 bytes) (0x000170 - 0x000178) align 8 MaxSize: 0x0178
...
/// Size: 0x0810 (2064 bytes) (0x000770 - 0x000810) align 16 MaxSize: 0x0810
struct FControlRigAnimInstanceProxy : FAnimInstanceProxy
{ 
	unsigned char                                      UnknownData00_1[0xA0];                                      // 0x0770   (0x00A0)  MISSED
};
...
/// Size: 0x0CC0 (3264 bytes) (0x000A10 - 0x000CC0) align 16 MaxSize: 0x0CC0
struct FControlRigSequencerAnimInstanceProxy : FAnimSequencerInstanceProxy
{ 
	unsigned char                                      UnknownData00_1[0x2B0];                                     // 0x0A10   (0x02B0)  MISSED
};
...
/// Size: 0x00C0 (192 bytes) (0x000068 - 0x0000C0) align 16 MaxSize: 0x00C0
...
/// Size: 0x0150 (336 bytes) (0x000068 - 0x000150) align 16 MaxSize: 0x0150
...
/// Size: 0x00F0 (240 bytes) (0x000068 - 0x0000F0) align 16 MaxSize: 0x00F0
...
/// Size: 0x0140 (320 bytes) (0x000068 - 0x000140) align 16 MaxSize: 0x0140
...
/// Size: 0x0270 (624 bytes) (0x000068 - 0x000270) align 16 MaxSize: 0x0270
...
/// Size: 0x00F8 (248 bytes) (0x000068 - 0x0000F8) align 8 MaxSize: 0x00F8
...
/// Size: 0x0030 (48 bytes) (0x000008 - 0x000030) align 16 MaxSize: 0x0030
...
/// Size: 0x0030 (48 bytes) (0x000030 - 0x000030) align 16 MaxSize: 0x0030
...
/// Size: 0x0110 (272 bytes) (0x000068 - 0x000110) align 16 MaxSize: 0x0110
...
/// Size: 0x0100 (256 bytes) (0x000068 - 0x000100) align 16 MaxSize: 0x0100
...
/// Size: 0x00E0 (224 bytes) (0x000068 - 0x0000E0) align 16 MaxSize: 0x00E0
...
/// Size: 0x00A0 (160 bytes) (0x000068 - 0x0000A0) align 16 MaxSize: 0x00A0
...
/// Size: 0x0200 (512 bytes) (0x000068 - 0x000200) align 16 MaxSize: 0x0200
...
/// Size: 0x00D0 (208 bytes) (0x0000B0 - 0x0000D0) align 16 MaxSize: 0x00D0
...
/// Size: 0x0110 (272 bytes) (0x0000D0 - 0x000110) align 16 MaxSize: 0x0110
...
/// Size: 0x00A0 (160 bytes) (0x0000A0 - 0x0000A0) align 16 MaxSize: 0x00A0
...
/// Size: 0x00D0 (208 bytes) (0x000068 - 0x0000D0) align 16 MaxSize: 0x00D0
...
/// Size: 0x0160 (352 bytes) (0x000068 - 0x000160) align 16 MaxSize: 0x0160
...
/// Size: 0x00B0 (176 bytes) (0x000068 - 0x0000B0) align 16 MaxSize: 0x00B0
...
/// Size: 0x01D0 (464 bytes) (0x000068 - 0x0001D0) align 16 MaxSize: 0x01D0
...
/// Size: 0x0130 (304 bytes) (0x000068 - 0x000130) align 16 MaxSize: 0x0130
...
/// Size: 0x0220 (544 bytes) (0x000068 - 0x000220) align 16 MaxSize: 0x0220
...
/// Size: 0x01B0 (432 bytes) (0x000068 - 0x0001B0) align 16 MaxSize: 0x01B0
...
/// Size: 0x0190 (400 bytes) (0x000068 - 0x000190) align 16 MaxSize: 0x0190
...
static_assert(sizeof(UControlRig) == 0x0658); // 1624 bytes (0x000030 - 0x000658)
...
static_assert(sizeof(UControlRigBlueprintGeneratedClass) == 0x0330); // 816 bytes (0x000330 - 0x000330)
static_assert(sizeof(FControlRigComponentMappedElement) == 0x00A0); // 160 bytes (0x000000 - 0x0000A0)
static_assert(sizeof(UControlRigComponent) == 0x05E0); // 1504 bytes (0x0004F8 - 0x0005E0)
static_assert(sizeof(AControlRigControlActor) == 0x0350); // 848 bytes (0x0002B8 - 0x000350)
static_assert(sizeof(AControlRigGizmoActor) == 0x02E0); // 736 bytes (0x0002B8 - 0x0002E0)
static_assert(sizeof(FControlRigGizmoDefinition) == 0x0060); // 96 bytes (0x000000 - 0x000060)
static_assert(sizeof(UControlRigGizmoLibrary) == 0x00E0); // 224 bytes (0x000030 - 0x0000E0)
static_assert(sizeof(UControlRigLayerInstance) == 0x02D0); // 720 bytes (0x0002C8 - 0x0002D0)
static_assert(sizeof(UControlRigValidationPass) == 0x0030); // 48 bytes (0x000030 - 0x000030)
...
static_assert(sizeof(UControlRigNumericalValidationPass) == 0x0068); // 104 bytes (0x000030 - 0x000068)
static_assert(sizeof(UControlRigObjectHolder) == 0x0040); // 64 bytes (0x000030 - 0x000040)
static_assert(sizeof(UControlRigSequence) == 0x0228); // 552 bytes (0x0001D0 - 0x000228)
static_assert(sizeof(UControlRigSequencerAnimInstance) == 0x02E0); // 736 bytes (0x0002D0 - 0x0002E0)
static_assert(sizeof(UControlRigSettings) == 0x0040); // 64 bytes (0x000040 - 0x000040)
static_assert(sizeof(UControlRigValidator) == 0x0070); // 112 bytes (0x000030 - 0x000070)
...
static_assert(sizeof(UMovieSceneControlRigParameterSection) == 0x02F0); // 752 bytes (0x000150 - 0x0002F0)
static_assert(sizeof(UMovieSceneControlRigParameterTrack) == 0x00D0); // 208 bytes (0x000098 - 0x0000D0)
...
static_assert(sizeof(FControlRigSequencerAnimInstanceProxy) == 0x0CC0); // 3264 bytes (0x000A10 - 0x000CC0)
...
static_assert(offsetof(UControlRig, ExecutionType) == 0x004D);
static_assert(offsetof(UControlRig, VM) == 0x0050);
static_assert(offsetof(UControlRig, Hierarchy) == 0x0058);
...
static_assert(offsetof(UControlRigComponent, ControlRigClass) == 0x04F8);
static_assert(offsetof(UControlRigComponent, MappedElements) == 0x0550);
static_assert(offsetof(UControlRigComponent, ControlRig) == 0x0568);
static_assert(offsetof(AControlRigControlActor, ActorToTrack) == 0x02B8);
static_assert(offsetof(AControlRigControlActor, ControlRigClass) == 0x02C0);
static_assert(offsetof(AControlRigControlActor, MaterialOverride) == 0x02D0);
static_assert(offsetof(AControlRigControlActor, ColorParameter) == 0x02D8);
static_assert(offsetof(AControlRigControlActor, ActorRootComponent) == 0x02F0);
static_assert(offsetof(AControlRigControlActor, ControlRig) == 0x02F8);
static_assert(offsetof(AControlRigControlActor, ControlNames) == 0x0300);
static_assert(offsetof(AControlRigControlActor, GizmoTransforms) == 0x0310);
...
static_assert(offsetof(AControlRigGizmoActor, ActorRootComponent) == 0x02B8);
static_assert(offsetof(AControlRigGizmoActor, StaticMeshComponent) == 0x02C0);
static_assert(offsetof(AControlRigGizmoActor, ControlName) == 0x02CC);
static_assert(offsetof(AControlRigGizmoActor, ColorParameterName) == 0x02D4);
...
static_assert(offsetof(UControlRigNumericalValidationPass, EventNameA) == 0x0044);
static_assert(offsetof(UControlRigNumericalValidationPass, EventNameB) == 0x004C);
static_assert(offsetof(UControlRigNumericalValidationPass, Pose) == 0x0058);
static_assert(offsetof(UControlRigObjectHolder, Objects) == 0x0030);
static_assert(offsetof(UControlRigSequence, LastExportedToAnimationSequence) == 0x01D0);
static_assert(offsetof(UControlRigSequence, LastExportedUsingSkeletalMesh) == 0x01F8);
static_assert(offsetof(UControlRigValidator, Passes) == 0x0030);
...
static_assert(offsetof(UMovieSceneControlRigParameterSection, ControlRig) == 0x0150);
static_assert(offsetof(UMovieSceneControlRigParameterSection, ControlRigClass) == 0x0158);
static_assert(offsetof(UMovieSceneControlRigParameterSection, ControlsMask) == 0x0160);
static_assert(offsetof(UMovieSceneControlRigParameterSection, TransformMask) == 0x0170);
...
static_assert(offsetof(UMovieSceneControlRigParameterTrack, ControlRig) == 0x00A8);
static_assert(offsetof(UMovieSceneControlRigParameterTrack, SectionToKey) == 0x00B0);
static_assert(offsetof(UMovieSceneControlRigParameterTrack, Sections) == 0x00B8);
static_assert(offsetof(UMovieSceneControlRigParameterTrack, TrackName) == 0x00C8);
