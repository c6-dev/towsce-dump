...
static_assert(sizeof(UPropertyAccess) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UPropertyEventBroadcaster) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UPropertyEventSubscriber) == 0x0030); // 48 bytes (0x000030 - 0x000030)
