...
{ 
public:
	FName                                              ChannelName;                                                // 0x0030   (0x0008)  
};
...
static_assert(sizeof(UMovieSceneScriptingChannel) == 0x0038); // 56 bytes (0x000030 - 0x000038)
static_assert(sizeof(UMovieSceneScriptingActorReferenceChannel) == 0x0068); // 104 bytes (0x000038 - 0x000068)
static_assert(sizeof(UMovieSceneScriptingBoolKey) == 0x0068); // 104 bytes (0x000048 - 0x000068)
static_assert(sizeof(UMovieSceneScriptingBoolChannel) == 0x0068); // 104 bytes (0x000038 - 0x000068)
static_assert(sizeof(UMovieSceneScriptingByteKey) == 0x0068); // 104 bytes (0x000048 - 0x000068)
static_assert(sizeof(UMovieSceneScriptingByteChannel) == 0x0068); // 104 bytes (0x000038 - 0x000068)
static_assert(sizeof(UMovieSceneScriptingEventKey) == 0x0068); // 104 bytes (0x000048 - 0x000068)
static_assert(sizeof(UMovieSceneScriptingEventChannel) == 0x0068); // 104 bytes (0x000038 - 0x000068)
static_assert(sizeof(UMovieSceneScriptingFloatKey) == 0x0068); // 104 bytes (0x000048 - 0x000068)
static_assert(sizeof(UMovieSceneScriptingFloatChannel) == 0x0068); // 104 bytes (0x000038 - 0x000068)
static_assert(sizeof(UMovieSceneScriptingIntegerKey) == 0x0068); // 104 bytes (0x000048 - 0x000068)
static_assert(sizeof(UMovieSceneScriptingIntegerChannel) == 0x0068); // 104 bytes (0x000038 - 0x000068)
static_assert(sizeof(UMovieSceneScriptingObjectPathKey) == 0x0068); // 104 bytes (0x000048 - 0x000068)
static_assert(sizeof(UMovieSceneScriptingObjectPathChannel) == 0x0068); // 104 bytes (0x000038 - 0x000068)
static_assert(sizeof(UMovieSceneScriptingStringKey) == 0x0068); // 104 bytes (0x000048 - 0x000068)
static_assert(sizeof(UMovieSceneScriptingStringChannel) == 0x0068); // 104 bytes (0x000038 - 0x000068)
...
static_assert(sizeof(UMovieSceneVectorTrackExtensions) == 0x0030); // 48 bytes (0x000030 - 0x000030)
