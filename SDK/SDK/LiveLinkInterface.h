...
public:
	...
	unsigned char                                      UnknownData01_7[0x107];                                     // 0x0061   (0x0107)  MISSED
};
...
static_assert(sizeof(ULiveLinkSourceFactory) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(ULiveLinkFrameInterpolationProcessor) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(ULiveLinkFrameTranslator) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(FLiveLinkSubjectName) == 0x0008); // 8 bytes (0x000000 - 0x000008)
static_assert(sizeof(ULiveLinkVirtualSubject) == 0x0168); // 360 bytes (0x000030 - 0x000168)
static_assert(sizeof(ULiveLinkFramePreProcessor) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(FLiveLinkSourceBufferManagementSettings) == 0x0058); // 88 bytes (0x000000 - 0x000058)
static_assert(sizeof(ULiveLinkSourceSettings) == 0x00A8); // 168 bytes (0x000030 - 0x0000A8)
static_assert(sizeof(ULiveLinkRole) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(ULiveLinkBasicRole) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(ULiveLinkAnimationRole) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(ULiveLinkTransformRole) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(ULiveLinkCameraRole) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(ULiveLinkController) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(FLiveLinkCurveConversionSettings) == 0x0050); // 80 bytes (0x000000 - 0x000050)
static_assert(sizeof(ULiveLinkCurveRemapSettings) == 0x00F8); // 248 bytes (0x0000A8 - 0x0000F8)
static_assert(sizeof(ULiveLinkLightRole) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(ULiveLinkSubjectSettings) == 0x0070); // 112 bytes (0x000030 - 0x000070)
...
static_assert(offsetof(ULiveLinkVirtualSubject, Role) == 0x0038);
static_assert(offsetof(ULiveLinkVirtualSubject, Subjects) == 0x0040);
static_assert(offsetof(ULiveLinkVirtualSubject, FrameTranslators) == 0x0050);
...
static_assert(offsetof(ULiveLinkSourceSettings, Mode) == 0x0030);
static_assert(offsetof(ULiveLinkSourceSettings, BufferSettings) == 0x0038);
static_assert(offsetof(ULiveLinkSourceSettings, ConnectionString) == 0x0090);
static_assert(offsetof(ULiveLinkSourceSettings, Factory) == 0x00A0);
static_assert(offsetof(FLiveLinkCurveConversionSettings, CurveConversionAssetMap) == 0x0000);
static_assert(offsetof(ULiveLinkCurveRemapSettings, CurveConversionSettings) == 0x00A8);
static_assert(offsetof(ULiveLinkSubjectSettings, PreProcessors) == 0x0030);
static_assert(offsetof(ULiveLinkSubjectSettings, InterpolationProcessor) == 0x0040);
static_assert(offsetof(ULiveLinkSubjectSettings, Translators) == 0x0048);
static_assert(offsetof(ULiveLinkSubjectSettings, Role) == 0x0058);
static_assert(offsetof(ULiveLinkSubjectSettings, FrameRate) == 0x0060);
