...
{ 
public:
	SDK_UNDEFINED(80,309) /* TMap<FName, TWeakObjectPtr<UObject*>> */ __um(DataSources);                           // 0x0030   (0x0050)  
};
...
static_assert(sizeof(UAnimationDataSourceRegistry) == 0x0080); // 128 bytes (0x000030 - 0x000080)
