...
public:
	...
	TMap<FName, class UClothConfigBase*>               ClothConfigs;                                               // 0x0058   (0x0050)  
...
/// Size: 0x00D4 (212 bytes) (0x000000 - 0x0000D4) align 4 MaxSize: 0x00D4
...
static_assert(sizeof(UClothConfigCommon) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UClothSharedConfigCommon) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UClothingAssetCustomData) == 0x0030); // 48 bytes (0x000030 - 0x000030)
...
static_assert(sizeof(UClothingAssetCommon) == 0x00F8); // 248 bytes (0x000050 - 0x0000F8)
static_assert(sizeof(UClothLODDataCommon_Legacy) == 0x0190); // 400 bytes (0x000030 - 0x000190)
...
static_assert(offsetof(UClothingAssetCommon, PhysicsAsset) == 0x0050);
static_assert(offsetof(UClothingAssetCommon, ClothConfigs) == 0x0058);
static_assert(offsetof(UClothingAssetCommon, LODData) == 0x00A8);
static_assert(offsetof(UClothingAssetCommon, LodMap) == 0x00B8);
static_assert(offsetof(UClothingAssetCommon, UsedBoneNames) == 0x00C8);
static_assert(offsetof(UClothingAssetCommon, UsedBoneIndices) == 0x00D8);
static_assert(offsetof(UClothingAssetCommon, CustomData) == 0x00F0);
static_assert(offsetof(UClothLODDataCommon_Legacy, PhysicalMeshData) == 0x0030);
static_assert(offsetof(UClothLODDataCommon_Legacy, ClothPhysicalMeshData) == 0x0038);
static_assert(offsetof(UClothLODDataCommon_Legacy, CollisionData) == 0x0130);
