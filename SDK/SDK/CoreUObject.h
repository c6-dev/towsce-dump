...
public:
	...
	// void ExecuteUbergraph(int32_t EntryPoint);                                                                               // [0x1c5deb0] Event|Public|BlueprintEvent 
};
...
/// Size: 0x0238 (568 bytes) (0x0000B8 - 0x000238) align 8 MaxSize: 0x0238
class UClass : public UStruct
{ 
public:
	unsigned char                                      UnknownData00_1[0x180];                                     // 0x00B8   (0x0180)  MISSED
};
...
/// Size: 0x02B8 (696 bytes) (0x000238 - 0x0002B8) align 8 MaxSize: 0x02B8
class UDynamicClass : public UClass
{ 
public:
	unsigned char                                      UnknownData00_1[0x80];                                      // 0x0238   (0x0080)  MISSED
};
...
/// Size: 0x03F0 (1008 bytes) (0x000238 - 0x0003F0) align 8 MaxSize: 0x03F0
class ULinkerPlaceholderClass : public UClass
{ 
public:
	unsigned char                                      UnknownData00_1[0x1B8];                                     // 0x0238   (0x01B8)  MISSED
};
...
{ 
public:
	unsigned char                                      UnknownData00_1[0x28];                                      // 0x0078   (0x0028)  MISSED
};
...
{ 
public:
	unsigned char                                      UnknownData00_1[0x20];                                      // 0x0078   (0x0020)  MISSED
};
...
{ 
	...
	SDK_UNDEFINED(80,0) /* TSet<FName> */              __um(RecursiveClassesExclusionSet);                         // 0x0090   (0x0050)  
...
static_assert(sizeof(UObject) == 0x0030); // 48 bytes (0x000000 - 0x000030)
static_assert(sizeof(UInterface) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UPackage) == 0x00B0); // 176 bytes (0x000030 - 0x0000B0)
static_assert(sizeof(UField) == 0x0038); // 56 bytes (0x000030 - 0x000038)
static_assert(sizeof(UStruct) == 0x00B8); // 184 bytes (0x000038 - 0x0000B8)
static_assert(sizeof(UClass) == 0x0238); // 568 bytes (0x0000B8 - 0x000238)
static_assert(sizeof(UGCObjectReferencer) == 0x0078); // 120 bytes (0x000030 - 0x000078)
static_assert(sizeof(UTextBuffer) == 0x0058); // 88 bytes (0x000030 - 0x000058)
static_assert(sizeof(UScriptStruct) == 0x00C8); // 200 bytes (0x0000B8 - 0x0000C8)
static_assert(sizeof(UFunction) == 0x00E8); // 232 bytes (0x0000B8 - 0x0000E8)
static_assert(sizeof(UDelegateFunction) == 0x00E8); // 232 bytes (0x0000E8 - 0x0000E8)
static_assert(sizeof(USparseDelegateFunction) == 0x00F8); // 248 bytes (0x0000E8 - 0x0000F8)
static_assert(sizeof(UDynamicClass) == 0x02B8); // 696 bytes (0x000238 - 0x0002B8)
static_assert(sizeof(UPackageMap) == 0x00E8); // 232 bytes (0x000030 - 0x0000E8)
static_assert(sizeof(UEnum) == 0x0068); // 104 bytes (0x000038 - 0x000068)
static_assert(sizeof(ULinkerPlaceholderClass) == 0x03F0); // 1008 bytes (0x000238 - 0x0003F0)
static_assert(sizeof(ULinkerPlaceholderExportObject) == 0x00F8); // 248 bytes (0x000030 - 0x0000F8)
static_assert(sizeof(ULinkerPlaceholderFunction) == 0x02A0); // 672 bytes (0x0000E8 - 0x0002A0)
static_assert(sizeof(UMetaData) == 0x00D0); // 208 bytes (0x000030 - 0x0000D0)
static_assert(sizeof(UObjectRedirector) == 0x0038); // 56 bytes (0x000030 - 0x000038)
static_assert(sizeof(UProperty) == 0x0078); // 120 bytes (0x000038 - 0x000078)
static_assert(sizeof(UEnumProperty) == 0x0088); // 136 bytes (0x000078 - 0x000088)
static_assert(sizeof(UArrayProperty) == 0x0080); // 128 bytes (0x000078 - 0x000080)
static_assert(sizeof(UObjectPropertyBase) == 0x0080); // 128 bytes (0x000078 - 0x000080)
static_assert(sizeof(UBoolProperty) == 0x0080); // 128 bytes (0x000078 - 0x000080)
static_assert(sizeof(UNumericProperty) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UByteProperty) == 0x0080); // 128 bytes (0x000078 - 0x000080)
static_assert(sizeof(UObjectProperty) == 0x0080); // 128 bytes (0x000080 - 0x000080)
static_assert(sizeof(UClassProperty) == 0x0088); // 136 bytes (0x000080 - 0x000088)
static_assert(sizeof(UDelegateProperty) == 0x0080); // 128 bytes (0x000078 - 0x000080)
static_assert(sizeof(UDoubleProperty) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UFloatProperty) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UIntProperty) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UInt8Property) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UInt16Property) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UInt64Property) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UInterfaceProperty) == 0x0080); // 128 bytes (0x000078 - 0x000080)
static_assert(sizeof(ULazyObjectProperty) == 0x0080); // 128 bytes (0x000080 - 0x000080)
static_assert(sizeof(UMapProperty) == 0x00A0); // 160 bytes (0x000078 - 0x0000A0)
static_assert(sizeof(UMulticastDelegateProperty) == 0x0080); // 128 bytes (0x000078 - 0x000080)
static_assert(sizeof(UMulticastInlineDelegateProperty) == 0x0080); // 128 bytes (0x000080 - 0x000080)
static_assert(sizeof(UMulticastSparseDelegateProperty) == 0x0080); // 128 bytes (0x000080 - 0x000080)
static_assert(sizeof(UNameProperty) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(USetProperty) == 0x0098); // 152 bytes (0x000078 - 0x000098)
static_assert(sizeof(USoftObjectProperty) == 0x0080); // 128 bytes (0x000080 - 0x000080)
static_assert(sizeof(USoftClassProperty) == 0x0088); // 136 bytes (0x000080 - 0x000088)
static_assert(sizeof(UStrProperty) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UStructProperty) == 0x0080); // 128 bytes (0x000078 - 0x000080)
static_assert(sizeof(UUInt16Property) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UUInt32Property) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UUInt64Property) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UWeakObjectProperty) == 0x0080); // 128 bytes (0x000080 - 0x000080)
static_assert(sizeof(UTextProperty) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UPropertyWrapper) == 0x0038); // 56 bytes (0x000030 - 0x000038)
static_assert(sizeof(UMulticastDelegatePropertyWrapper) == 0x0038); // 56 bytes (0x000038 - 0x000038)
static_assert(sizeof(UMulticastInlineDelegatePropertyWrapper) == 0x0038); // 56 bytes (0x000038 - 0x000038)
...
static_assert(offsetof(UField, Next) == 0x0030);
static_assert(offsetof(UStruct, SuperStruct) == 0x0038);
static_assert(offsetof(UStruct, Children) == 0x0040);
