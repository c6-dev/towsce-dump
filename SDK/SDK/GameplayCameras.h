...
public:
	...
	unsigned char                                      UnknownData00_7[0x38];                                      // 0x0088   (0x0038)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData00_7[0x3C];                                      // 0x00A4   (0x003C)  MISSED
};
...
static_assert(sizeof(USimpleCameraShakePattern) == 0x0040); // 64 bytes (0x000030 - 0x000040)
static_assert(sizeof(UConstantCameraShakePattern) == 0x0058); // 88 bytes (0x000040 - 0x000058)
static_assert(sizeof(UCompositeCameraShakePattern) == 0x0050); // 80 bytes (0x000030 - 0x000050)
...
static_assert(sizeof(UMatineeCameraShakePattern) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UMovieSceneMatineeCameraShakeEvaluator) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UMatineeCameraShakeFunctionLibrary) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(FPerlinNoiseShaker) == 0x0008); // 8 bytes (0x000000 - 0x000008)
static_assert(sizeof(UPerlinNoiseCameraShakePattern) == 0x00C0); // 192 bytes (0x000040 - 0x0000C0)
static_assert(sizeof(FWaveOscillator) == 0x000C); // 12 bytes (0x000000 - 0x00000C)
static_assert(sizeof(UWaveOscillatorCameraShakePattern) == 0x00E0); // 224 bytes (0x000040 - 0x0000E0)
static_assert(offsetof(UConstantCameraShakePattern, LocationOffset) == 0x0040);
static_assert(offsetof(UConstantCameraShakePattern, RotationOffset) == 0x004C);
...
static_assert(offsetof(UPerlinNoiseCameraShakePattern, X) == 0x0048);
static_assert(offsetof(UPerlinNoiseCameraShakePattern, Y) == 0x0050);
static_assert(offsetof(UPerlinNoiseCameraShakePattern, Z) == 0x0058);
static_assert(offsetof(UPerlinNoiseCameraShakePattern, Pitch) == 0x0068);
static_assert(offsetof(UPerlinNoiseCameraShakePattern, Yaw) == 0x0070);
static_assert(offsetof(UPerlinNoiseCameraShakePattern, Roll) == 0x0078);
static_assert(offsetof(UPerlinNoiseCameraShakePattern, FOV) == 0x0080);
static_assert(offsetof(FWaveOscillator, InitialOffsetType) == 0x0008);
static_assert(offsetof(UWaveOscillatorCameraShakePattern, X) == 0x0048);
static_assert(offsetof(UWaveOscillatorCameraShakePattern, Y) == 0x0054);
static_assert(offsetof(UWaveOscillatorCameraShakePattern, Z) == 0x0060);
static_assert(offsetof(UWaveOscillatorCameraShakePattern, Pitch) == 0x0074);
static_assert(offsetof(UWaveOscillatorCameraShakePattern, Yaw) == 0x0080);
static_assert(offsetof(UWaveOscillatorCameraShakePattern, Roll) == 0x008C);
static_assert(offsetof(UWaveOscillatorCameraShakePattern, FOV) == 0x0098);
