...
{ 
public:
	class UNiagaraComponent*                           NiagaraComponent;                                           // 0x02B8   (0x0008)  
	bool                                               bDestroyOnSystemFinish : 1;                                 // 0x02C0:0 (0x0001)  
...
public:
	...
	FVector                                            CameraViewportLocation[7];                                  // 0x005C   (0x0054)  
	FRotator                                           CameraViewportRotation[7];                                  // 0x00B0   (0x0054)  
...
/// Size: 0x06A0 (1696 bytes) (0x0004F8 - 0x0006A0) align 16 MaxSize: 0x06A0
class UNiagaraComponent : public UFXSystemComponent
{ 
public:
	class UNiagaraSystem*                              Asset;                                                      // 0x04F8   (0x0008)  
	ENiagaraTickBehavior                               TickBehavior;                                               // 0x0500   (0x0001)  
	unsigned char                                      UnknownData00_6[0x3];                                       // 0x0501   (0x0003)  MISSED
	int32_t                                            RandomSeedOffset;                                           // 0x0504   (0x0004)  
	FNiagaraUserRedirectionParameterStore              OverrideParameters;                                         // 0x0508   (0x00C8)  
	bool                                               bForceSolo : 1;                                             // 0x05D0:0 (0x0001)  
	bool                                               bEnableGpuComputeDebug : 1;                                 // 0x05D0:1 (0x0001)  
	unsigned char                                      UnknownData01_3[0x2F];                                      // 0x05D1   (0x002F)  MISSED
	bool                                               bAutoDestroy : 1;                                           // 0x0600:0 (0x0001)  
	bool                                               bRenderingEnabled : 1;                                      // 0x0600:1 (0x0001)  
	bool                                               bAutoManageAttachment : 1;                                  // 0x0600:2 (0x0001)  
	bool                                               bAutoAttachWeldSimulatedBodies : 1;                         // 0x0600:3 (0x0001)  
	unsigned char                                      UnknownData02_5[0x3];                                       // 0x0601   (0x0003)  MISSED
	float                                              MaxTimeBeforeForceUpdateTransform;                          // 0x0604   (0x0004)  
	TArray<FNiagaraMaterialOverride>                   EmitterMaterials;                                           // 0x0608   (0x0010)  
	unsigned char                                      UnknownData03_6[0x8];                                       // 0x0618   (0x0008)  MISSED
	SDK_UNDEFINED(16,333) /* FMulticastInlineDelegate */ __um(OnSystemFinished);                                   // 0x0620   (0x0010)  
	TWeakObjectPtr<class USceneComponent*>             AutoAttachParent;                                           // 0x0630   (0x0008)  
	FName                                              AutoAttachSocketName;                                       // 0x0638   (0x0008)  
	EAttachmentRule                                    AutoAttachLocationRule;                                     // 0x0640   (0x0001)  
	EAttachmentRule                                    AutoAttachRotationRule;                                     // 0x0641   (0x0001)  
	EAttachmentRule                                    AutoAttachScaleRule;                                        // 0x0642   (0x0001)  
	unsigned char                                      UnknownData04_7[0x5D];                                      // 0x0643   (0x005D)  MISSED
...
{ 
public:
	TMap<class UNiagaraSystem*, FNCPool>               WorldParticleSystemPools;                                   // 0x0030   (0x0050)  
...
public:
	...
	unsigned char                                      UnknownData00_7[0x16];                                      // 0x006A   (0x0016)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData01_6[0x2];                                       // 0x0142   (0x0002)  MISSED
...
{ 
public:
	SDK_UNDEFINED(80,334) /* TSet<FName> */            __um(SuppressActivationList);                               // 0x0030   (0x0050)  
	SDK_UNDEFINED(80,335) /* TSet<FName> */            __um(ForceAutoPooolingList);                                // 0x0080   (0x0050)  
	SDK_UNDEFINED(80,336) /* TSet<FNiagaraEmitterNameSettingsRef> */ __um(SuppressEmitterList);                    // 0x00D0   (0x0050)  
};
...
public:
	...
	FName                                              ExposedName;                                                // 0x0064   (0x0008)  
...
/// Size: 0x0278 (632 bytes) (0x000078 - 0x000278) align 8 MaxSize: 0x0278
...
/// Size: 0x00F8 (248 bytes) (0x000078 - 0x0000F8) align 8 MaxSize: 0x00F8
...
{ 
public:
	SDK_UNDEFINED(80,337) /* TSet<int32_t> */          __um(OutputShaderStages);                                   // 0x0040   (0x0050)  
	SDK_UNDEFINED(80,338) /* TSet<int32_t> */          __um(IterationShaderStages);                                // 0x0090   (0x0050)  
};
...
/// Size: 0x01C8 (456 bytes) (0x000100 - 0x0001C8) align 8 MaxSize: 0x01C8
...
public:
	...
	TMap<uint64_t, class UTextureRenderTarget2DArray*> ManagedRenderTargets;                                       // 0x0178   (0x0050)  
...
/// Size: 0x0170 (368 bytes) (0x000100 - 0x000170) align 8 MaxSize: 0x0170
...
public:
	...
	unsigned char                                      UnknownData01_7[0x56];                                      // 0x0132   (0x0056)  MISSED
...
/// Size: 0x0158 (344 bytes) (0x0000E0 - 0x000158) align 8 MaxSize: 0x0158
...
/// Size: 0x01B0 (432 bytes) (0x0000E0 - 0x0001B0) align 8 MaxSize: 0x01B0
class UNiagaraDataInterfaceRenderTarget2D : public UNiagaraDataInterfaceRWBase
{ 
public:
	FIntPoint                                          Size;                                                       // 0x00E0   (0x0008)  
	ENiagaraMipMapGeneration                           MipMapGeneration;                                           // 0x00E8   (0x0001)  
	TEnumAsByte<ETextureRenderTargetFormat>            OverrideRenderTargetFormat;                                 // 0x00E9   (0x0001)  
	...
	TMap<uint64_t, class UTextureRenderTarget2D*>      ManagedRenderTargets;                                       // 0x0160   (0x0050)  
};

/// Class /Script/Niagara.NiagaraDataInterfaceRenderTarget2DArray
/// Size: 0x0160 (352 bytes) (0x0000E0 - 0x000160) align 8 MaxSize: 0x0160
...
public:
	...
	FNiagaraUserParameterBinding                       RenderTargetUserParameter;                                  // 0x00F0   (0x0020)  
	TMap<uint64_t, class UTextureRenderTarget2DArray*> ManagedRenderTargets;                                       // 0x0110   (0x0050)  
};
...
public:
	...
	FNiagaraUserParameterBinding                       RenderTargetUserParameter;                                  // 0x00E8   (0x0020)  
	TMap<uint64_t, class UTextureRenderTargetCube*>    ManagedRenderTargets;                                       // 0x0108   (0x0050)  
};
...
public:
	...
	unsigned char                                      UnknownData00_5[0x2];                                       // 0x00EE   (0x0002)  MISSED
	FNiagaraUserParameterBinding                       RenderTargetUserParameter;                                  // 0x00F0   (0x0020)  
	TMap<uint64_t, class UTextureRenderTargetVolume*>  ManagedRenderTargets;                                       // 0x0110   (0x0050)  
};
...
public:
	...
	FName                                              ExcludeBoneName;                                            // 0x00B8   (0x0008)  
	bool                                               bExcludeBone : 1;                                           // 0x00C0:0 (0x0001)  
	unsigned char                                      UnknownData03_5[0x3];                                       // 0x00C1   (0x0003)  MISSED
	int32_t                                            UvSetIndex;                                                 // 0x00C4   (0x0004)  
	bool                                               bRequireCurrentFrameData;                                   // 0x00C8   (0x0001)  
	unsigned char                                      UnknownData04_7[0x7];                                       // 0x00C9   (0x0007)  MISSED
};
...
/// Size: 0x0178 (376 bytes) (0x000078 - 0x000178) align 8 MaxSize: 0x0178
...
/// Size: 0x01F8 (504 bytes) (0x000078 - 0x0001F8) align 8 MaxSize: 0x01F8
...
/// Size: 0x02A8 (680 bytes) (0x000030 - 0x0002A8) align 8 MaxSize: 0x02A8
...
public:
	...
	SDK_UNDEFINED(80,339) /* TSet<uint32_t> */         __um(SpawnStages);                                          // 0x0120   (0x0050)  
	...
	unsigned char                                      UnknownData05_5[0x7];                                       // 0x0171   (0x0007)  MISSED
	...
	unsigned char                                      UnknownData06_7[0xD8];                                      // 0x01D0   (0x00D8)  MISSED
};
...
/// Size: 0x0338 (824 bytes) (0x000080 - 0x000338) align 8 MaxSize: 0x0338
...
public:
	...
	unsigned char                                      UnknownData02_7[0x30];                                      // 0x0308   (0x0030)  MISSED
};
...
/// Size: 0x08A0 (2208 bytes) (0x000080 - 0x0008A0) align 8 MaxSize: 0x08A0
...
public:
	...
	unsigned char                                      UnknownData06_6[0x68];                                      // 0x0820   (0x0068)  MISSED
	...
	unsigned char                                      UnknownData07_7[0x3];                                       // 0x089D   (0x0003)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData00_7[0x28];                                      // 0x00C0   (0x0028)  MISSED
...
{ 
public:
	FName                                              Namespace;                                                  // 0x0030   (0x0008)  
	TArray<FNiagaraVariable>                           Parameters;                                                 // 0x0038   (0x0010)  
	class UMaterialParameterCollection*                SourceMaterialCollection;                                   // 0x0048   (0x0008)  
	class UNiagaraParameterCollectionInstance*         DefaultInstance;                                            // 0x0050   (0x0008)  
	FGuid                                              CompileId;                                                  // 0x0058   (0x0010)  
};
...
public:
	...
	TWeakObjectPtr<class UNiagaraSystem*>              System;                                                     // 0x0048   (0x0008)  
	unsigned char                                      UnknownData01_7[0x20];                                      // 0x0050   (0x0020)  MISSED
...
{ 
public:
	class UNiagaraBaselineController*                  Controller;                                                 // 0x02B8   (0x0008)  
	class UTextRenderComponent*                        Label;                                                      // 0x02C0   (0x0008)  
};
...
/// Size: 0x0060 (96 bytes) (0x000040 - 0x000060) align 16 MaxSize: 0x0060
...
{ 
public:
	class UNiagaraSystem*                              System;                                                     // 0x02B8   (0x0008)  
	ENiagaraPreviewGridResetMode                       ResetMode;                                                  // 0x02C0   (0x0001)  
	unsigned char                                      UnknownData00_6[0x7];                                       // 0x02C1   (0x0007)  MISSED
	class UNiagaraPreviewAxis*                         PreviewAxisX;                                               // 0x02C8   (0x0008)  
	class UNiagaraPreviewAxis*                         PreviewAxisY;                                               // 0x02D0   (0x0008)  
	class UClass*                                      PreviewClass;                                               // 0x02D8   (0x0008)  
	float                                              SpacingX;                                                   // 0x02E0   (0x0004)  
	float                                              SpacingY;                                                   // 0x02E4   (0x0004)  
	int32_t                                            NumX;                                                       // 0x02E8   (0x0004)  
	int32_t                                            NumY;                                                       // 0x02EC   (0x0004)  
	TArray<class UChildActorComponent*>                PreviewComponents;                                          // 0x02F0   (0x0010)  
...
/// Size: 0x0868 (2152 bytes) (0x000080 - 0x000868) align 8 MaxSize: 0x0868
...
public:
	...
	unsigned char                                      UnknownData06_7[0xA0];                                      // 0x07C8   (0x00A0)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData02_6[0x10];                                      // 0x01C0   (0x0010)  MISSED
	...
	unsigned char                                      UnknownData03_7[0x8];                                       // 0x02E0   (0x0008)  MISSED
...
public:
	...
	TArray<FText>                                      QualityLevels;                                              // 0x0058   (0x0010)  
	TMap<FString, FText>                               ComponentRendererWarningsPerClass;                          // 0x0068   (0x0050)  
	TEnumAsByte<ETextureRenderTargetFormat>            DefaultRenderTargetFormat;                                  // 0x00B8   (0x0001)  
	ENiagaraGpuBufferFormat                            DefaultGridFormat;                                          // 0x00B9   (0x0001)  
	unsigned char                                      UnknownData00_6[0x2];                                       // 0x00BA   (0x0002)  MISSED
	ENiagaraDefaultRendererMotionVectorSetting         DefaultRendererMotionVectorSetting;                         // 0x00BC   (0x0004)  
	TEnumAsByte<ENDISkelMesh_GpuMaxInfluences>         NDISkelMesh_GpuMaxInfluences;                               // 0x00C0   (0x0001)  
	TEnumAsByte<ENDISkelMesh_GpuUniformSamplingFormat> NDISkelMesh_GpuUniformSamplingFormat;                       // 0x00C1   (0x0001)  
	TEnumAsByte<ENDISkelMesh_AdjacencyTriangleIndexFormat> NDISkelMesh_AdjacencyTriangleIndexFormat;               // 0x00C2   (0x0001)  
	unsigned char                                      UnknownData01_6[0x5];                                       // 0x00C3   (0x0005)  MISSED
	class UNiagaraEffectType*                          DefaultEffectTypePtr;                                       // 0x00C8   (0x0008)  
};
...
public:
	...
	FName                                              SimulationStageName;                                        // 0x0038   (0x0008)  
	bool                                               bEnabled : 1;                                               // 0x0040:0 (0x0001)  
...
/// Size: 0x0AB8 (2744 bytes) (0x000080 - 0x000AB8) align 8 MaxSize: 0x0AB8
...
public:
	...
	unsigned char                                      UnknownData06_7[0x78];                                      // 0x0A40   (0x0078)  MISSED
};
...
/// Size: 0x04A0 (1184 bytes) (0x000038 - 0x0004A0) align 8 MaxSize: 0x04A0
...
public:
	...
	unsigned char                                      UnknownData03_6[0x10];                                      // 0x00A0   (0x0010)  MISSED
	FNiagaraSystemCompiledData                         SystemCompiledData;                                         // 0x00B0   (0x0218)  
	FNiagaraUserRedirectionParameterStore              ExposedParameters;                                          // 0x02C8   (0x00C8)  
	FBox                                               FixedBounds;                                                // 0x0390   (0x001C)  
	bool                                               bAutoDeactivate;                                            // 0x03AC   (0x0001)  
	unsigned char                                      UnknownData04_6[0x3];                                       // 0x03AD   (0x0003)  MISSED
	float                                              WarmupTime;                                                 // 0x03B0   (0x0004)  
	int32_t                                            WarmupTickCount;                                            // 0x03B4   (0x0004)  
	float                                              WarmupTickDelta;                                            // 0x03B8   (0x0004)  
	bool                                               bHasSystemScriptDIsWithPerInstanceData;                     // 0x03BC   (0x0001)  
	bool                                               bNeedsGPUContextInitForDataInterfaces;                      // 0x03BD   (0x0001)  
	unsigned char                                      UnknownData05_6[0x2];                                       // 0x03BE   (0x0002)  MISSED
	TArray<FName>                                      UserDINamesReadInSystemScripts;                             // 0x03C0   (0x0010)  
	unsigned char                                      UnknownData06_7[0xD0];                                      // 0x03D0   (0x00D0)  MISSED
};
...
static_assert(sizeof(ANiagaraActor) == 0x02C8); // 712 bytes (0x0002B8 - 0x0002C8)
...
static_assert(sizeof(UNiagaraBakerSettings) == 0x0120); // 288 bytes (0x000030 - 0x000120)
...
static_assert(sizeof(UNiagaraComponent) == 0x06A0); // 1696 bytes (0x0004F8 - 0x0006A0)
...
static_assert(sizeof(UNiagaraComponentPool) == 0x0088); // 136 bytes (0x000030 - 0x000088)
...
static_assert(sizeof(UNiagaraRendererProperties) == 0x0080); // 128 bytes (0x000030 - 0x000080)
...
static_assert(sizeof(UNiagaraComponentRendererProperties) == 0x01B8); // 440 bytes (0x000080 - 0x0001B8)
static_assert(sizeof(UNiagaraComponentSettings) == 0x0120); // 288 bytes (0x000030 - 0x000120)
static_assert(sizeof(UNiagaraConvertInPlaceUtilityBase) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UNiagaraDataInterface) == 0x0040); // 64 bytes (0x000030 - 0x000040)
static_assert(sizeof(UNiagaraDataInterface2DArrayTexture) == 0x0058); // 88 bytes (0x000040 - 0x000058)
static_assert(sizeof(UNiagaraDataInterfaceArray) == 0x0058); // 88 bytes (0x000040 - 0x000058)
static_assert(sizeof(UNiagaraDataInterfaceArrayFloat) == 0x0068); // 104 bytes (0x000058 - 0x000068)
static_assert(sizeof(UNiagaraDataInterfaceArrayFloat2) == 0x0068); // 104 bytes (0x000058 - 0x000068)
static_assert(sizeof(UNiagaraDataInterfaceArrayFloat3) == 0x0068); // 104 bytes (0x000058 - 0x000068)
static_assert(sizeof(UNiagaraDataInterfaceArrayFloat4) == 0x0068); // 104 bytes (0x000058 - 0x000068)
static_assert(sizeof(UNiagaraDataInterfaceArrayColor) == 0x0068); // 104 bytes (0x000058 - 0x000068)
static_assert(sizeof(UNiagaraDataInterfaceArrayQuat) == 0x0068); // 104 bytes (0x000058 - 0x000068)
static_assert(sizeof(UNiagaraDataInterfaceArrayFunctionLibrary) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UNiagaraDataInterfaceArrayInt32) == 0x0068); // 104 bytes (0x000058 - 0x000068)
static_assert(sizeof(UNiagaraDataInterfaceArrayBool) == 0x0068); // 104 bytes (0x000058 - 0x000068)
static_assert(sizeof(UNiagaraDataInterfaceAudioSubmix) == 0x0048); // 72 bytes (0x000040 - 0x000048)
static_assert(sizeof(UNiagaraDataInterfaceAudioOscilloscope) == 0x0050); // 80 bytes (0x000040 - 0x000050)
static_assert(sizeof(UNiagaraDataInterfaceAudioPlayer) == 0x0078); // 120 bytes (0x000040 - 0x000078)
static_assert(sizeof(UNiagaraDataInterfaceAudioSpectrum) == 0x0058); // 88 bytes (0x000048 - 0x000058)
static_assert(sizeof(UNiagaraDataInterfaceCamera) == 0x0048); // 72 bytes (0x000040 - 0x000048)
static_assert(sizeof(UNiagaraDataInterfaceCollisionQuery) == 0x0050); // 80 bytes (0x000040 - 0x000050)
static_assert(sizeof(UNiagaraDataInterfaceCurveBase) == 0x0078); // 120 bytes (0x000040 - 0x000078)
static_assert(sizeof(UNiagaraDataInterfaceColorCurve) == 0x0278); // 632 bytes (0x000078 - 0x000278)
static_assert(sizeof(UNiagaraDataInterfaceCubeTexture) == 0x0050); // 80 bytes (0x000040 - 0x000050)
static_assert(sizeof(UNiagaraDataInterfaceCurlNoise) == 0x0050); // 80 bytes (0x000040 - 0x000050)
static_assert(sizeof(UNiagaraDataInterfaceCurve) == 0x00F8); // 248 bytes (0x000078 - 0x0000F8)
static_assert(sizeof(UNiagaraDataInterfaceDebugDraw) == 0x0040); // 64 bytes (0x000040 - 0x000040)
static_assert(sizeof(UNiagaraParticleCallbackHandler) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(FNiagaraUserParameterBinding) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(sizeof(UNiagaraDataInterfaceExport) == 0x0070); // 112 bytes (0x000040 - 0x000070)
static_assert(sizeof(UNiagaraDataInterfaceGBuffer) == 0x0040); // 64 bytes (0x000040 - 0x000040)
static_assert(sizeof(UNiagaraDataInterfaceRWBase) == 0x00E0); // 224 bytes (0x000040 - 0x0000E0)
static_assert(sizeof(UNiagaraDataInterfaceGrid2D) == 0x0100); // 256 bytes (0x0000E0 - 0x000100)
static_assert(sizeof(UNiagaraDataInterfaceGrid2DCollection) == 0x01C8); // 456 bytes (0x000100 - 0x0001C8)
static_assert(sizeof(UNiagaraDataInterfaceGrid2DCollectionReader) == 0x0170); // 368 bytes (0x000100 - 0x000170)
static_assert(sizeof(UNiagaraDataInterfaceGrid3D) == 0x0108); // 264 bytes (0x0000E0 - 0x000108)
static_assert(sizeof(UNiagaraDataInterfaceGrid3DCollection) == 0x0188); // 392 bytes (0x000108 - 0x000188)
static_assert(sizeof(UNiagaraDataInterfaceIntRenderTarget2D) == 0x0158); // 344 bytes (0x0000E0 - 0x000158)
static_assert(sizeof(UNiagaraDataInterfaceLandscape) == 0x0060); // 96 bytes (0x000040 - 0x000060)
static_assert(sizeof(UNiagaraDataInterfaceMeshRendererInfo) == 0x0058); // 88 bytes (0x000040 - 0x000058)
static_assert(sizeof(UNiagaraDataInterfaceNeighborGrid3D) == 0x0110); // 272 bytes (0x000108 - 0x000110)
static_assert(sizeof(UNiagaraDataInterfaceOcclusion) == 0x0040); // 64 bytes (0x000040 - 0x000040)
static_assert(sizeof(UNiagaraDataInterfaceParticleRead) == 0x00F0); // 240 bytes (0x0000E0 - 0x0000F0)
static_assert(sizeof(UNiagaraDataInterfacePlatformSet) == 0x0070); // 112 bytes (0x000040 - 0x000070)
static_assert(sizeof(UNiagaraDataInterfaceRenderTarget2D) == 0x01B0); // 432 bytes (0x0000E0 - 0x0001B0)
static_assert(sizeof(UNiagaraDataInterfaceRenderTarget2DArray) == 0x0160); // 352 bytes (0x0000E0 - 0x000160)
static_assert(sizeof(UNiagaraDataInterfaceRenderTargetCube) == 0x0158); // 344 bytes (0x0000E0 - 0x000158)
static_assert(sizeof(UNiagaraDataInterfaceRenderTargetVolume) == 0x0160); // 352 bytes (0x0000E0 - 0x000160)
static_assert(sizeof(UNiagaraDataInterfaceSimpleCounter) == 0x0040); // 64 bytes (0x000040 - 0x000040)
static_assert(sizeof(UNiagaraDataInterfaceSkeletalMesh) == 0x00D0); // 208 bytes (0x000040 - 0x0000D0)
static_assert(sizeof(UNiagaraDataInterfaceSpline) == 0x0068); // 104 bytes (0x000040 - 0x000068)
static_assert(sizeof(FNDIStaticMeshSectionFilter) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(UNiagaraDataInterfaceStaticMesh) == 0x0090); // 144 bytes (0x000040 - 0x000090)
static_assert(sizeof(UNiagaraDataInterfaceTexture) == 0x0050); // 80 bytes (0x000040 - 0x000050)
static_assert(sizeof(UNiagaraDataInterfaceVector2DCurve) == 0x0178); // 376 bytes (0x000078 - 0x000178)
static_assert(sizeof(UNiagaraDataInterfaceVector4Curve) == 0x0278); // 632 bytes (0x000078 - 0x000278)
static_assert(sizeof(UNiagaraDataInterfaceVectorCurve) == 0x01F8); // 504 bytes (0x000078 - 0x0001F8)
static_assert(sizeof(UNiagaraDataInterfaceVectorField) == 0x0050); // 80 bytes (0x000040 - 0x000050)
static_assert(sizeof(UNiagaraDataInterfaceVolumeTexture) == 0x0058); // 88 bytes (0x000040 - 0x000058)
...
static_assert(sizeof(UNiagaraDebugHUDSettings) == 0x0130); // 304 bytes (0x000030 - 0x000130)
static_assert(sizeof(UNiagaraEditorDataBase) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UNiagaraEditorParametersAdapterBase) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UNiagaraSignificanceHandler) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UNiagaraSignificanceHandlerDistance) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UNiagaraSignificanceHandlerAge) == 0x0030); // 48 bytes (0x000030 - 0x000030)
...
static_assert(sizeof(UNiagaraEffectType) == 0x00A0); // 160 bytes (0x000030 - 0x0000A0)
...
static_assert(sizeof(UNiagaraEmitter) == 0x02A8); // 680 bytes (0x000030 - 0x0002A8)
static_assert(sizeof(UNiagaraEventReceiverEmitterAction) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UNiagaraEventReceiverEmitterAction_SpawnParticles) == 0x0038); // 56 bytes (0x000030 - 0x000038)
static_assert(sizeof(UNiagaraFunctionLibrary) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UNiagaraLightRendererProperties) == 0x0338); // 824 bytes (0x000080 - 0x000338)
...
static_assert(sizeof(UNiagaraMeshRendererProperties) == 0x08A0); // 2208 bytes (0x000080 - 0x0008A0)
static_assert(sizeof(UNiagaraMessageDataBase) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UNiagaraParameterCollectionInstance) == 0x00E8); // 232 bytes (0x000030 - 0x0000E8)
static_assert(sizeof(UNiagaraParameterCollection) == 0x0068); // 104 bytes (0x000030 - 0x000068)
static_assert(sizeof(UNiagaraParameterDefinitionsBase) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UNiagaraBaselineController) == 0x0070); // 112 bytes (0x000030 - 0x000070)
static_assert(sizeof(UNiagaraBaselineController_Basic) == 0x0088); // 136 bytes (0x000070 - 0x000088)
static_assert(sizeof(ANiagaraPerfBaselineActor) == 0x02C8); // 712 bytes (0x0002B8 - 0x0002C8)
static_assert(sizeof(UNiagaraPrecompileContainer) == 0x0048); // 72 bytes (0x000030 - 0x000048)
static_assert(sizeof(ANiagaraPreviewBase) == 0x02B8); // 696 bytes (0x0002B8 - 0x0002B8)
static_assert(sizeof(UNiagaraPreviewAxis) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UNiagaraPreviewAxis_InterpParamBase) == 0x0040); // 64 bytes (0x000030 - 0x000040)
static_assert(sizeof(UNiagaraPreviewAxis_InterpParamInt32) == 0x0048); // 72 bytes (0x000040 - 0x000048)
static_assert(sizeof(UNiagaraPreviewAxis_InterpParamFloat) == 0x0048); // 72 bytes (0x000040 - 0x000048)
static_assert(sizeof(UNiagaraPreviewAxis_InterpParamVector2D) == 0x0050); // 80 bytes (0x000040 - 0x000050)
static_assert(sizeof(UNiagaraPreviewAxis_InterpParamVector) == 0x0058); // 88 bytes (0x000040 - 0x000058)
static_assert(sizeof(UNiagaraPreviewAxis_InterpParamVector4) == 0x0060); // 96 bytes (0x000040 - 0x000060)
static_assert(sizeof(UNiagaraPreviewAxis_InterpParamLinearColor) == 0x0060); // 96 bytes (0x000040 - 0x000060)
static_assert(sizeof(ANiagaraPreviewGrid) == 0x0308); // 776 bytes (0x0002B8 - 0x000308)
...
static_assert(sizeof(UNiagaraRibbonRendererProperties) == 0x0868); // 2152 bytes (0x000080 - 0x000868)
...
static_assert(sizeof(UNiagaraScript) == 0x02E8); // 744 bytes (0x000030 - 0x0002E8)
static_assert(sizeof(UNiagaraScriptSourceBase) == 0x0050); // 80 bytes (0x000030 - 0x000050)
static_assert(sizeof(UNiagaraSettings) == 0x00D0); // 208 bytes (0x000040 - 0x0000D0)
static_assert(sizeof(UNiagaraSimulationStageBase) == 0x0048); // 72 bytes (0x000030 - 0x000048)
static_assert(sizeof(FNiagaraVariableDataInterfaceBinding) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(sizeof(UNiagaraSimulationStageGeneric) == 0x0078); // 120 bytes (0x000048 - 0x000078)
static_assert(sizeof(UNiagaraSpriteRendererProperties) == 0x0AB8); // 2744 bytes (0x000080 - 0x000AB8)
...
static_assert(sizeof(UNiagaraSystem) == 0x04A0); // 1184 bytes (0x000038 - 0x0004A0)
...
static_assert(sizeof(FNiagaraWorldManagerTickFunction) == 0x0048); // 72 bytes (0x000040 - 0x000048)
...
static_assert(offsetof(ANiagaraActor, NiagaraComponent) == 0x02B8);
...
static_assert(offsetof(UNiagaraBakerSettings, FramesPerDimension) == 0x0040);
static_assert(offsetof(UNiagaraBakerSettings, OutputTextures) == 0x0048);
static_assert(offsetof(UNiagaraBakerSettings, CameraViewportMode) == 0x0058);
static_assert(offsetof(UNiagaraBakerSettings, CameraViewportLocation) == 0x005C);
static_assert(offsetof(UNiagaraBakerSettings, CameraViewportRotation) == 0x00B0);
...
static_assert(offsetof(UNiagaraComponent, Asset) == 0x04F8);
static_assert(offsetof(UNiagaraComponent, TickBehavior) == 0x0500);
static_assert(offsetof(UNiagaraComponent, OverrideParameters) == 0x0508);
static_assert(offsetof(UNiagaraComponent, EmitterMaterials) == 0x0608);
static_assert(offsetof(UNiagaraComponent, AutoAttachParent) == 0x0630);
static_assert(offsetof(UNiagaraComponent, AutoAttachSocketName) == 0x0638);
static_assert(offsetof(UNiagaraComponent, AutoAttachLocationRule) == 0x0640);
static_assert(offsetof(UNiagaraComponent, AutoAttachRotationRule) == 0x0641);
static_assert(offsetof(UNiagaraComponent, AutoAttachScaleRule) == 0x0642);
static_assert(offsetof(FNCPoolElement, Component) == 0x0000);
static_assert(offsetof(FNCPool, FreeElements) == 0x0000);
static_assert(offsetof(UNiagaraComponentPool, WorldParticleSystemPools) == 0x0030);
...
static_assert(offsetof(UNiagaraRendererProperties, Platforms) == 0x0030);
static_assert(offsetof(UNiagaraRendererProperties, MotionVectorSetting) == 0x0064);
...
static_assert(offsetof(UNiagaraComponentRendererProperties, RendererVisibilityTagBinding) == 0x00E8);
static_assert(offsetof(UNiagaraComponentRendererProperties, TemplateComponent) == 0x0148);
static_assert(offsetof(UNiagaraComponentRendererProperties, PropertyBindings) == 0x0150);
static_assert(offsetof(UNiagaraDataInterface2DArrayTexture, Texture) == 0x0040);
static_assert(offsetof(UNiagaraDataInterfaceArrayFloat, FloatData) == 0x0058);
static_assert(offsetof(UNiagaraDataInterfaceArrayFloat2, FloatData) == 0x0058);
static_assert(offsetof(UNiagaraDataInterfaceArrayFloat3, FloatData) == 0x0058);
static_assert(offsetof(UNiagaraDataInterfaceArrayFloat4, FloatData) == 0x0058);
static_assert(offsetof(UNiagaraDataInterfaceArrayColor, ColorData) == 0x0058);
static_assert(offsetof(UNiagaraDataInterfaceArrayQuat, QuatData) == 0x0058);
static_assert(offsetof(UNiagaraDataInterfaceArrayInt32, IntData) == 0x0058);
static_assert(offsetof(UNiagaraDataInterfaceArrayBool, BoolData) == 0x0058);
static_assert(offsetof(UNiagaraDataInterfaceAudioSubmix, Submix) == 0x0040);
static_assert(offsetof(UNiagaraDataInterfaceAudioOscilloscope, Submix) == 0x0040);
static_assert(offsetof(UNiagaraDataInterfaceAudioPlayer, SoundToPlay) == 0x0040);
static_assert(offsetof(UNiagaraDataInterfaceAudioPlayer, Attenuation) == 0x0048);
static_assert(offsetof(UNiagaraDataInterfaceAudioPlayer, Concurrency) == 0x0050);
static_assert(offsetof(UNiagaraDataInterfaceAudioPlayer, ParameterNames) == 0x0058);
static_assert(offsetof(UNiagaraDataInterfaceCurveBase, ShaderLUT) == 0x0040);
static_assert(offsetof(UNiagaraDataInterfaceCurveBase, ExposedName) == 0x0064);
static_assert(offsetof(UNiagaraDataInterfaceCurveBase, ExposedTexture) == 0x0070);
static_assert(offsetof(UNiagaraDataInterfaceColorCurve, RedCurve) == 0x0078);
static_assert(offsetof(UNiagaraDataInterfaceColorCurve, GreenCurve) == 0x00F8);
static_assert(offsetof(UNiagaraDataInterfaceColorCurve, BlueCurve) == 0x0178);
static_assert(offsetof(UNiagaraDataInterfaceColorCurve, AlphaCurve) == 0x01F8);
static_assert(offsetof(UNiagaraDataInterfaceCubeTexture, Texture) == 0x0040);
static_assert(offsetof(UNiagaraDataInterfaceCurve, Curve) == 0x0078);
static_assert(offsetof(FNiagaraUserParameterBinding, Parameter) == 0x0000);
static_assert(offsetof(UNiagaraDataInterfaceExport, CallbackHandlerParameter) == 0x0040);
static_assert(offsetof(UNiagaraDataInterfaceExport, GPUAllocationMode) == 0x0060);
static_assert(offsetof(UNiagaraDataInterfaceGrid2D, WorldBBoxSize) == 0x00F4);
static_assert(offsetof(UNiagaraDataInterfaceGrid2DCollection, RenderTargetUserParameter) == 0x0100);
static_assert(offsetof(UNiagaraDataInterfaceGrid2DCollection, OverrideBufferFormat) == 0x0120);
static_assert(offsetof(UNiagaraDataInterfaceGrid2DCollection, ManagedRenderTargets) == 0x0178);
static_assert(offsetof(UNiagaraDataInterfaceGrid2DCollectionReader, EmitterName) == 0x0100);
static_assert(offsetof(UNiagaraDataInterfaceGrid2DCollectionReader, DIName) == 0x0110);
static_assert(offsetof(UNiagaraDataInterfaceGrid3D, NumCells) == 0x00E0);
static_assert(offsetof(UNiagaraDataInterfaceGrid3D, SetResolutionMethod) == 0x00F4);
static_assert(offsetof(UNiagaraDataInterfaceGrid3D, WorldBBoxSize) == 0x00F8);
static_assert(offsetof(UNiagaraDataInterfaceGrid3DCollection, RenderTargetUserParameter) == 0x0110);
static_assert(offsetof(UNiagaraDataInterfaceGrid3DCollection, OverrideBufferFormat) == 0x0130);
static_assert(offsetof(UNiagaraDataInterfaceIntRenderTarget2D, Size) == 0x00E0);
static_assert(offsetof(UNiagaraDataInterfaceIntRenderTarget2D, RenderTargetUserParameter) == 0x00E8);
static_assert(offsetof(UNiagaraDataInterfaceIntRenderTarget2D, ManagedRenderTargets) == 0x0108);
static_assert(offsetof(UNiagaraDataInterfaceLandscape, SourceLandscape) == 0x0040);
static_assert(offsetof(UNiagaraDataInterfaceLandscape, SourceMode) == 0x0048);
static_assert(offsetof(UNiagaraDataInterfaceLandscape, PhysicalMaterials) == 0x0050);
static_assert(offsetof(UNiagaraDataInterfaceMeshRendererInfo, MeshRenderer) == 0x0040);
static_assert(offsetof(UNiagaraDataInterfaceParticleRead, EmitterName) == 0x00E0);
static_assert(offsetof(UNiagaraDataInterfacePlatformSet, Platforms) == 0x0040);
static_assert(offsetof(UNiagaraDataInterfaceRenderTarget2D, Size) == 0x00E0);
static_assert(offsetof(UNiagaraDataInterfaceRenderTarget2D, MipMapGeneration) == 0x00E8);
static_assert(offsetof(UNiagaraDataInterfaceRenderTarget2D, OverrideRenderTargetFormat) == 0x00E9);
static_assert(offsetof(UNiagaraDataInterfaceRenderTarget2D, RenderTargetUserParameter) == 0x00F0);
static_assert(offsetof(UNiagaraDataInterfaceRenderTarget2D, ManagedRenderTargets) == 0x0160);
static_assert(offsetof(UNiagaraDataInterfaceRenderTarget2DArray, Size) == 0x00E0);
static_assert(offsetof(UNiagaraDataInterfaceRenderTarget2DArray, OverrideRenderTargetFormat) == 0x00EC);
static_assert(offsetof(UNiagaraDataInterfaceRenderTarget2DArray, RenderTargetUserParameter) == 0x00F0);
static_assert(offsetof(UNiagaraDataInterfaceRenderTarget2DArray, ManagedRenderTargets) == 0x0110);
static_assert(offsetof(UNiagaraDataInterfaceRenderTargetCube, OverrideRenderTargetFormat) == 0x00E4);
static_assert(offsetof(UNiagaraDataInterfaceRenderTargetCube, RenderTargetUserParameter) == 0x00E8);
static_assert(offsetof(UNiagaraDataInterfaceRenderTargetCube, ManagedRenderTargets) == 0x0108);
static_assert(offsetof(UNiagaraDataInterfaceRenderTargetVolume, Size) == 0x00E0);
static_assert(offsetof(UNiagaraDataInterfaceRenderTargetVolume, OverrideRenderTargetFormat) == 0x00EC);
static_assert(offsetof(UNiagaraDataInterfaceRenderTargetVolume, RenderTargetUserParameter) == 0x00F0);
static_assert(offsetof(UNiagaraDataInterfaceRenderTargetVolume, ManagedRenderTargets) == 0x0110);
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, SourceMode) == 0x0040);
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, Source) == 0x0048);
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, MeshUserParameter) == 0x0050);
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, SourceComponent) == 0x0070);
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, SkinningMode) == 0x0078);
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, SamplingRegions) == 0x0080);
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, FilteredBones) == 0x0098);
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, FilteredSockets) == 0x00A8);
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, ExcludeBoneName) == 0x00B8);
static_assert(offsetof(UNiagaraDataInterfaceSpline, Source) == 0x0040);
static_assert(offsetof(UNiagaraDataInterfaceSpline, SplineUserParameter) == 0x0048);
static_assert(offsetof(FNDIStaticMeshSectionFilter, AllowedMaterialSlots) == 0x0000);
static_assert(offsetof(UNiagaraDataInterfaceStaticMesh, SourceMode) == 0x0040);
static_assert(offsetof(UNiagaraDataInterfaceStaticMesh, DefaultMesh) == 0x0048);
static_assert(offsetof(UNiagaraDataInterfaceStaticMesh, Source) == 0x0050);
static_assert(offsetof(UNiagaraDataInterfaceStaticMesh, SourceComponent) == 0x0058);
static_assert(offsetof(UNiagaraDataInterfaceStaticMesh, SectionFilter) == 0x0060);
static_assert(offsetof(UNiagaraDataInterfaceStaticMesh, FilteredSockets) == 0x0078);
static_assert(offsetof(UNiagaraDataInterfaceTexture, Texture) == 0x0040);
static_assert(offsetof(UNiagaraDataInterfaceVector2DCurve, XCurve) == 0x0078);
static_assert(offsetof(UNiagaraDataInterfaceVector2DCurve, YCurve) == 0x00F8);
static_assert(offsetof(UNiagaraDataInterfaceVector4Curve, XCurve) == 0x0078);
static_assert(offsetof(UNiagaraDataInterfaceVector4Curve, YCurve) == 0x00F8);
static_assert(offsetof(UNiagaraDataInterfaceVector4Curve, ZCurve) == 0x0178);
static_assert(offsetof(UNiagaraDataInterfaceVector4Curve, WCurve) == 0x01F8);
static_assert(offsetof(UNiagaraDataInterfaceVectorCurve, XCurve) == 0x0078);
static_assert(offsetof(UNiagaraDataInterfaceVectorCurve, YCurve) == 0x00F8);
static_assert(offsetof(UNiagaraDataInterfaceVectorCurve, ZCurve) == 0x0178);
static_assert(offsetof(UNiagaraDataInterfaceVectorField, Field) == 0x0040);
static_assert(offsetof(UNiagaraDataInterfaceVolumeTexture, Texture) == 0x0040);
...
static_assert(offsetof(UNiagaraDebugHUDSettings, Data) == 0x0050);
...
static_assert(offsetof(UNiagaraEffectType, UpdateFrequency) == 0x0030);
static_assert(offsetof(UNiagaraEffectType, CullReaction) == 0x0034);
...
static_assert(offsetof(UNiagaraEmitter, AllocationMode) == 0x0038);
static_assert(offsetof(UNiagaraEmitter, UpdateScriptProps) == 0x0040);
static_assert(offsetof(UNiagaraEmitter, SpawnScriptProps) == 0x0068);
static_assert(offsetof(UNiagaraEmitter, SimTarget) == 0x0090);
static_assert(offsetof(UNiagaraEmitter, FixedBounds) == 0x0094);
static_assert(offsetof(UNiagaraEmitter, GlobalSpawnCountScaleOverrides) == 0x00B8);
static_assert(offsetof(UNiagaraEmitter, Platforms) == 0x00D0);
static_assert(offsetof(UNiagaraEmitter, ScalabilityOverrides) == 0x0100);
static_assert(offsetof(UNiagaraEmitter, UniqueEmitterName) == 0x0178);
static_assert(offsetof(UNiagaraEmitter, RendererProperties) == 0x0188);
static_assert(offsetof(UNiagaraEmitter, EventHandlerScriptProps) == 0x0198);
static_assert(offsetof(UNiagaraEmitter, SimulationStages) == 0x01A8);
static_assert(offsetof(UNiagaraEmitter, GPUComputeScript) == 0x01B8);
static_assert(offsetof(UNiagaraEmitter, SharedEventGeneratorIds) == 0x01C0);
static_assert(offsetof(UNiagaraLightRendererProperties, ColorAdd) == 0x008C);
static_assert(offsetof(UNiagaraLightRendererProperties, LightRenderingEnabledBinding) == 0x00A0);
static_assert(offsetof(UNiagaraLightRendererProperties, LightExponentBinding) == 0x00F8);
static_assert(offsetof(UNiagaraLightRendererProperties, PositionBinding) == 0x0150);
static_assert(offsetof(UNiagaraLightRendererProperties, ColorBinding) == 0x01A8);
static_assert(offsetof(UNiagaraLightRendererProperties, RadiusBinding) == 0x0200);
static_assert(offsetof(UNiagaraLightRendererProperties, VolumetricScatteringBinding) == 0x0258);
static_assert(offsetof(UNiagaraLightRendererProperties, RendererVisibilityTagBinding) == 0x02B0);
...
static_assert(offsetof(UNiagaraMeshRendererProperties, Meshes) == 0x0080);
static_assert(offsetof(UNiagaraMeshRendererProperties, SourceMode) == 0x0090);
static_assert(offsetof(UNiagaraMeshRendererProperties, SortMode) == 0x0091);
static_assert(offsetof(UNiagaraMeshRendererProperties, OverrideMaterials) == 0x0098);
static_assert(offsetof(UNiagaraMeshRendererProperties, SubImageSize) == 0x00A8);
static_assert(offsetof(UNiagaraMeshRendererProperties, FacingMode) == 0x00B0);
static_assert(offsetof(UNiagaraMeshRendererProperties, LockedAxis) == 0x00B8);
static_assert(offsetof(UNiagaraMeshRendererProperties, LockedAxisSpace) == 0x00C4);
static_assert(offsetof(UNiagaraMeshRendererProperties, PositionBinding) == 0x00D8);
static_assert(offsetof(UNiagaraMeshRendererProperties, ColorBinding) == 0x0130);
static_assert(offsetof(UNiagaraMeshRendererProperties, VelocityBinding) == 0x0188);
static_assert(offsetof(UNiagaraMeshRendererProperties, MeshOrientationBinding) == 0x01E0);
static_assert(offsetof(UNiagaraMeshRendererProperties, ScaleBinding) == 0x0238);
static_assert(offsetof(UNiagaraMeshRendererProperties, SubImageIndexBinding) == 0x0290);
static_assert(offsetof(UNiagaraMeshRendererProperties, DynamicMaterialBinding) == 0x02E8);
static_assert(offsetof(UNiagaraMeshRendererProperties, DynamicMaterial1Binding) == 0x0340);
static_assert(offsetof(UNiagaraMeshRendererProperties, DynamicMaterial2Binding) == 0x0398);
static_assert(offsetof(UNiagaraMeshRendererProperties, DynamicMaterial3Binding) == 0x03F0);
static_assert(offsetof(UNiagaraMeshRendererProperties, MaterialRandomBinding) == 0x0448);
static_assert(offsetof(UNiagaraMeshRendererProperties, CustomSortingBinding) == 0x04A0);
static_assert(offsetof(UNiagaraMeshRendererProperties, NormalizedAgeBinding) == 0x04F8);
static_assert(offsetof(UNiagaraMeshRendererProperties, CameraOffsetBinding) == 0x0550);
static_assert(offsetof(UNiagaraMeshRendererProperties, RendererVisibilityTagBinding) == 0x05A8);
static_assert(offsetof(UNiagaraMeshRendererProperties, MeshIndexBinding) == 0x0600);
static_assert(offsetof(UNiagaraMeshRendererProperties, MaterialParameterBindings) == 0x0658);
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevPositionBinding) == 0x0668);
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevScaleBinding) == 0x06C0);
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevMeshOrientationBinding) == 0x0718);
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevCameraOffsetBinding) == 0x0770);
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevVelocityBinding) == 0x07C8);
static_assert(offsetof(UNiagaraMeshRendererProperties, ParticleMesh) == 0x0888);
static_assert(offsetof(UNiagaraMeshRendererProperties, PivotOffset) == 0x0890);
static_assert(offsetof(UNiagaraMeshRendererProperties, PivotOffsetSpace) == 0x089C);
static_assert(offsetof(UNiagaraParameterCollectionInstance, Collection) == 0x0030);
static_assert(offsetof(UNiagaraParameterCollectionInstance, OverridenParameters) == 0x0038);
static_assert(offsetof(UNiagaraParameterCollectionInstance, ParameterStorage) == 0x0048);
static_assert(offsetof(UNiagaraParameterCollection, Namespace) == 0x0030);
static_assert(offsetof(UNiagaraParameterCollection, Parameters) == 0x0038);
static_assert(offsetof(UNiagaraParameterCollection, SourceMaterialCollection) == 0x0048);
static_assert(offsetof(UNiagaraParameterCollection, DefaultInstance) == 0x0050);
static_assert(offsetof(UNiagaraParameterCollection, CompileId) == 0x0058);
static_assert(offsetof(UNiagaraBaselineController, EffectType) == 0x0038);
static_assert(offsetof(UNiagaraBaselineController, Owner) == 0x0040);
static_assert(offsetof(UNiagaraBaselineController, System) == 0x0048);
static_assert(offsetof(UNiagaraBaselineController_Basic, SpawnedComponents) == 0x0078);
static_assert(offsetof(ANiagaraPerfBaselineActor, Controller) == 0x02B8);
static_assert(offsetof(ANiagaraPerfBaselineActor, Label) == 0x02C0);
static_assert(offsetof(UNiagaraPrecompileContainer, Scripts) == 0x0030);
static_assert(offsetof(UNiagaraPrecompileContainer, System) == 0x0040);
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamBase, Param) == 0x0030);
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamVector2D, Min) == 0x0040);
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamVector2D, Max) == 0x0048);
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamVector, Min) == 0x0040);
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamVector, Max) == 0x004C);
...
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamLinearColor, Min) == 0x0040);
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamLinearColor, Max) == 0x0050);
static_assert(offsetof(ANiagaraPreviewGrid, System) == 0x02B8);
static_assert(offsetof(ANiagaraPreviewGrid, ResetMode) == 0x02C0);
static_assert(offsetof(ANiagaraPreviewGrid, PreviewAxisX) == 0x02C8);
static_assert(offsetof(ANiagaraPreviewGrid, PreviewAxisY) == 0x02D0);
static_assert(offsetof(ANiagaraPreviewGrid, PreviewClass) == 0x02D8);
static_assert(offsetof(ANiagaraPreviewGrid, PreviewComponents) == 0x02F0);
...
static_assert(offsetof(UNiagaraRibbonRendererProperties, Shape) == 0x00F5);
static_assert(offsetof(UNiagaraRibbonRendererProperties, CustomVertices) == 0x0108);
static_assert(offsetof(UNiagaraRibbonRendererProperties, TessellationMode) == 0x011C);
static_assert(offsetof(UNiagaraRibbonRendererProperties, PositionBinding) == 0x0130);
static_assert(offsetof(UNiagaraRibbonRendererProperties, ColorBinding) == 0x0188);
static_assert(offsetof(UNiagaraRibbonRendererProperties, VelocityBinding) == 0x01E0);
static_assert(offsetof(UNiagaraRibbonRendererProperties, NormalizedAgeBinding) == 0x0238);
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonTwistBinding) == 0x0290);
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonWidthBinding) == 0x02E8);
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonFacingBinding) == 0x0340);
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonIdBinding) == 0x0398);
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonLinkOrderBinding) == 0x03F0);
static_assert(offsetof(UNiagaraRibbonRendererProperties, MaterialRandomBinding) == 0x0448);
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterialBinding) == 0x04A0);
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterial1Binding) == 0x04F8);
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterial2Binding) == 0x0550);
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterial3Binding) == 0x05A8);
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonUVDistance) == 0x0600);
static_assert(offsetof(UNiagaraRibbonRendererProperties, U0OverrideBinding) == 0x0658);
static_assert(offsetof(UNiagaraRibbonRendererProperties, V0RangeOverrideBinding) == 0x06B0);
static_assert(offsetof(UNiagaraRibbonRendererProperties, U1OverrideBinding) == 0x0708);
static_assert(offsetof(UNiagaraRibbonRendererProperties, V1RangeOverrideBinding) == 0x0760);
static_assert(offsetof(UNiagaraRibbonRendererProperties, MaterialParameterBindings) == 0x07B8);
...
static_assert(offsetof(UNiagaraScript, ScriptExecutionParamStore) == 0x00C0);
static_assert(offsetof(UNiagaraScript, ScriptExecutionBoundParameters) == 0x0158);
static_assert(offsetof(UNiagaraScript, CachedScriptVMId) == 0x0168);
static_assert(offsetof(UNiagaraScript, CachedScriptVM) == 0x01D0);
static_assert(offsetof(UNiagaraScript, CachedParameterCollectionReferences) == 0x02C0);
static_assert(offsetof(UNiagaraScript, CachedDefaultDataInterfaces) == 0x02D0);
static_assert(offsetof(UNiagaraSettings, DefaultEffectType) == 0x0040);
static_assert(offsetof(UNiagaraSettings, QualityLevels) == 0x0058);
static_assert(offsetof(UNiagaraSettings, ComponentRendererWarningsPerClass) == 0x0068);
static_assert(offsetof(UNiagaraSettings, DefaultRenderTargetFormat) == 0x00B8);
static_assert(offsetof(UNiagaraSettings, DefaultGridFormat) == 0x00B9);
static_assert(offsetof(UNiagaraSettings, DefaultRendererMotionVectorSetting) == 0x00BC);
static_assert(offsetof(UNiagaraSettings, NDISkelMesh_GpuMaxInfluences) == 0x00C0);
static_assert(offsetof(UNiagaraSettings, NDISkelMesh_GpuUniformSamplingFormat) == 0x00C1);
static_assert(offsetof(UNiagaraSettings, NDISkelMesh_AdjacencyTriangleIndexFormat) == 0x00C2);
static_assert(offsetof(UNiagaraSettings, DefaultEffectTypePtr) == 0x00C8);
static_assert(offsetof(UNiagaraSimulationStageBase, Script) == 0x0030);
static_assert(offsetof(UNiagaraSimulationStageBase, SimulationStageName) == 0x0038);
static_assert(offsetof(FNiagaraVariableDataInterfaceBinding, BoundVariable) == 0x0000);
static_assert(offsetof(UNiagaraSimulationStageGeneric, IterationSource) == 0x0048);
static_assert(offsetof(UNiagaraSimulationStageGeneric, DataInterface) == 0x0058);
...
static_assert(offsetof(UNiagaraSpriteRendererProperties, PivotOffsetBinding) == 0x05B8);
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaterialRandomBinding) == 0x0610);
static_assert(offsetof(UNiagaraSpriteRendererProperties, CustomSortingBinding) == 0x0668);
static_assert(offsetof(UNiagaraSpriteRendererProperties, NormalizedAgeBinding) == 0x06C0);
static_assert(offsetof(UNiagaraSpriteRendererProperties, RendererVisibilityTagBinding) == 0x0718);
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaterialParameterBindings) == 0x0770);
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevPositionBinding) == 0x0780);
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevVelocityBinding) == 0x07D8);
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteRotationBinding) == 0x0830);
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteSizeBinding) == 0x0888);
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteFacingBinding) == 0x08E0);
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteAlignmentBinding) == 0x0938);
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevCameraOffsetBinding) == 0x0990);
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevPivotOffsetBinding) == 0x09E8);
...
static_assert(offsetof(UNiagaraSystem, EffectType) == 0x0040);
static_assert(offsetof(UNiagaraSystem, ScalabilityOverrides) == 0x0050);
static_assert(offsetof(UNiagaraSystem, SystemScalabilityOverrides) == 0x0060);
static_assert(offsetof(UNiagaraSystem, EmitterHandles) == 0x0070);
static_assert(offsetof(UNiagaraSystem, ParameterCollectionOverrides) == 0x0080);
static_assert(offsetof(UNiagaraSystem, SystemSpawnScript) == 0x0090);
static_assert(offsetof(UNiagaraSystem, SystemUpdateScript) == 0x0098);
static_assert(offsetof(UNiagaraSystem, SystemCompiledData) == 0x00B0);
static_assert(offsetof(UNiagaraSystem, ExposedParameters) == 0x02C8);
static_assert(offsetof(UNiagaraSystem, FixedBounds) == 0x0390);
static_assert(offsetof(UNiagaraSystem, UserDINamesReadInSystemScripts) == 0x03C0);
